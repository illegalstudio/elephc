...
F5 suit exactement `ZEND_RECV_VARIADIC` : le compteur checked progresse pour les captures
positionnelles, tandis que chaque clé nommée variadique conserve l'ordinal courant de php-src. Le
diagnostic ne fabrique aucun nom de paramètre pour une clé variadique.
