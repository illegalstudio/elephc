...
use crate::types::{
    is_php_integer_array_key, AttrArgValue, EnumCaseInfo, EnumCaseValue, FunctionSig,
...
fn reflection_class_is_iterable(info: &crate::types::ClassInfo, is_enum: bool) -> bool {
    if info.is_abstract || is_enum {
        return false;
    }
    info.interfaces
