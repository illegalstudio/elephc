...
//!   A cleanup-tracked non-parameter slot returned by move is excluded only when
...
mod tests {
    ...
    use crate::ir::{Immediate, LocalSlotId};
    ...
    /// An IterStart without an owner keeps by_ref and does not invent a slot.
    #[test]
