...
//!
//! Key details:
//! - `check` returns `Bool` and rejects only the `user` arguments php rejects — an array or
//!   an object — because the declared `string|int` boundary is COERCIVE for everything else.
