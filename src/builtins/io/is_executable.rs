//! Purpose:
//! Home of the PHP `is_executable` builtin: its declaration and lowering.
//!
//! Called from:
...
/// Lowers an `is_executable` call by dispatching to the shared io emitter.
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::io::lower_is_executable(ctx, inst)
}
