//! Purpose:
//! Home of the internal `__elephc_phar_set_file_metadata` PHAR intrinsic: its declaration, checker contract, and semantic target. Compiler-synthesized; not PHP-visible.
//!
//! Called from:
...
builtin! {
    ...
    semantics: crate::builtins::semantics::runtime_fn_semantics(
        crate::ir::RuntimeFnId::ElephcPharSetFileMetadata,
    ),
