//! Purpose:
//! Home of the internal `__elephc_phar_get_file_metadata` PHAR intrinsic: its declaration,
...
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::io::lower_elephc_phar_get_file_metadata(ctx, inst)
}
