//! Purpose:
//! Home of the internal `__elephc_phar_get_file_metadata` PHAR intrinsic: its declaration, checker contract, and semantic target. Compiler-synthesized; not PHP-visible.
//!
//! Called from:
