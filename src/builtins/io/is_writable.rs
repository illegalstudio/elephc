//! Purpose:
//! Home of the PHP `is_writable` builtin: its declaration and lowering.
//!
//! Called from:
...
/// Lowers an `is_writable` call by dispatching to the shared io emitter.
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::io::lower_is_writable(ctx, inst)
}
