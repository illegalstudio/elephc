//! Purpose:
//! Home of the PHP `stream_filter_prepend` builtin: its declaration, type-check hook, and lowering.
//!
//! Called from:
...
/// Lowers a `stream_filter_prepend` call by dispatching to the shared io emitter.
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::io::lower_stream_filter_attach(ctx, inst, "stream_filter_prepend")
}
