//! Purpose:
//! Binds mb_ereg_replace to the shared mbregex replacement operation.
//!
//! Called from:
...
builtin! {
    ...
    lazy_check: true,
    semantics: crate::builtins::semantics::runtime_fn_semantics(crate::ir::RuntimeFnId::MbEregReplace),
}
