//! Purpose:
//! Binds PHP's Windows-only active console code-page setter to its runtime identity.
//!
//! Called from:
...
builtin! {
    ...
    semantics: windows_only_runtime_fn_semantics(RuntimeFnId::SapiWindowsCpSet),
}
