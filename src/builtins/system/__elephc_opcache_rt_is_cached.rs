//! Purpose:
//! Home of the internal `__elephc_opcache_rt_is_cached` builtin: the runtime script cache's
//! is_cached operation, reached by path.
//!
//! Called from:
...
builtin! {
    contract: "__elephc_opcache_rt_is_cached",
    semantics: crate::builtins::semantics::runtime_fn_semantics(
        crate::ir::RuntimeFnId::ElephcOpcacheRtIsCached,
    ),
}
