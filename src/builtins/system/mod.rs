...
pub mod __elephc_opcache_rt_blacklist_entry;
...
pub mod debug_backtrace;
pub mod debug_print_backtrace;
pub mod define;
pub mod defined;
...
pub mod get_mangled_object_vars;
pub mod get_required_files;
...
pub mod pcntl_daemon;
pub mod pcntl_exec;
pub mod pcntl_errno;
pub mod pcntl_fork;
pub mod pcntl_get_last_error;
pub mod pcntl_getcpu;
pub mod pcntl_getcpuaffinity;
pub mod pcntl_getpriority;
pub mod pcntl_getqos_class;
mod pcntl_linux_support;
pub mod pcntl_setcpuaffinity;
pub mod pcntl_setns;
pub mod pcntl_setpriority;
pub mod pcntl_setqos_class;
mod pcntl_signal_support;
pub mod pcntl_signal;
pub mod pcntl_signal_dispatch;
pub mod pcntl_signal_get_handler;
pub mod pcntl_sigprocmask;
pub mod pcntl_sigtimedwait;
pub mod pcntl_sigwaitinfo;
pub mod pcntl_strerror;
pub mod pcntl_unshare;
pub mod pcntl_wait;
pub mod pcntl_waitid;
pub mod pcntl_waitpid;
mod pcntl_wait_support;
pub mod pcntl_wexitstatus;
pub mod pcntl_wifcontinued;
pub mod pcntl_wifexited;
pub mod pcntl_wifsignaled;
pub mod pcntl_wifstopped;
pub mod pcntl_wstopsig;
pub mod pcntl_wtermsig;
pub mod php_uname;
pub mod phpversion;
pub mod posix_setpgid;
pub mod posix_setsid;
pub mod preg_match;
