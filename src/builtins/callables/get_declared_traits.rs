//! Purpose:
//! Home of the PHP `get_declared_traits` builtin: its declaration and lowering.
//!
//! Called from:
...
/// Lowers a `get_declared_traits` call by dispatching to the shared declared-names emitter.
