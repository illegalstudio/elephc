...
/// Lowers a `class_exists` call by dispatching to the shared class-like existence emitter.
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::lower_class_like_exists(ctx, inst, "class_exists")
}
