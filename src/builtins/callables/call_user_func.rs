//! Purpose:
//! Home of the PHP `call_user_func` builtin: its declaration, type-check hook, and lowering.
//!
//! Called from:
...
/// Lowers a `call_user_func` builtin-call escape by dispatching to the shared emitter.
///
