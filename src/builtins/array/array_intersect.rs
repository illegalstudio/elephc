//! Purpose:
//! Home of the PHP `array_intersect` builtin: its declaration, type-check hook, and lowering.
//!
//! Called from:
...
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::arrays::lower_array_intersect(ctx, inst)
}
