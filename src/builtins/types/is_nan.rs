//! Purpose:
//! Home of the PHP `is_nan` builtin: its declaration and lowering.
//!
//! Called from:
...
/// Lowers an `is_nan` call by dispatching to the EIR math-module NaN-predicate emitter.
fn lower(ctx: &mut FunctionContext, inst: &Instruction) -> Result<(), CodegenIrError> {
    crate::codegen_ir::lower_inst::builtins::math::lower_is_nan(ctx, inst)
}
