...
#[derive(Debug, Clone)]
/// A class with all traits fully expanded, property/method/constant conflicts resolved,
...
#[derive(Clone)]
/// Cached result of fully expanding a trait: all properties, methods, and constants
