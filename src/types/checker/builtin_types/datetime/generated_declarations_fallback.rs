...
method("diff")
    ...
    .body_exact(vec![
        ...
        s_assign("tts", e_method_call(e_var("targetObject"), "getTimestamp", vec![])),
        s_assign("mut", e_method_call(e_var("targetObject"), "getMicrosecond", vec![])),
                ...
                s_if(
                    ...
                    s_if(
                        ...
                        vec![
                            ...
                            s_assign("parseZone", e_method_call(e_var("zoneObject"), "getName", vec![])),
            ...
            s_if(
                ...
                s_if(
                    ...
                    s_if(
                        ...
                        Some(vec![
                        s_assign("saved", e_call("date_default_timezone_get", vec![])),
                        s_expr(e_call("date_default_timezone_set", vec![e_static_call("DateTime", "__elephc_runtime_timezone_name", vec![e_method_call(e_var("timezone"), "getName", vec![])])])),
                        s_assign("ts", e_call("__elephc_mktime_raw", vec![e_var("H"), e_var("mi"), e_var("se"), e_var("mo"), e_var("da"), e_var("Y")])),
                        s_expr(e_call("date_default_timezone_set", vec![e_var("saved")])),
                    ]),
                    ),
...
fn decl_class_datetimezone_method_17_elephc_assert_initialized() -> MethodBuilder {
method("__elephc_assert_initialized")
    .final_()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimezone() -> Stmt {
    class("DateTimeZone")
        ...
        .method(decl_class_datetimezone_method_17_elephc_assert_initialized())
        .build()
}
