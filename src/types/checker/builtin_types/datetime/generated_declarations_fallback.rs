...
method("__construct")
    ...
    .body_exact(vec![
        ...
        s_assign("len", e_call("strlen", vec![e_var("duration")])),
        s_if(
            e_binop(e_call("substr", vec![e_var("duration"), e_int(0), e_int(1)]), BinOp::StrictNotEq, e_str("P")),
            vec![
                s_throw(e_new("DateMalformedIntervalStringException", vec![e_str("Unknown or bad format")])),
            ],
            vec![],
            None,
        ),
        s_assign("num", e_int(0)),
        s_assign("inTime", e_int(0)),
        s_assign("units", e_int(0)),
        s_assign("p", e_int(0)),
        s_while(e_binop(e_var("p"), BinOp::Lt, e_var("len")), vec![
            s_assign("c", e_index(e_var("duration"), e_var("p"))),
            ...
            s_if(
                ...
                vec![
                    s_assign("num", e_binop(e_binop(e_var("num"), BinOp::Mul, e_int(10)), BinOp::Add, e_binop(e_var("o"), BinOp::Sub, e_int(48)))),
            ...
            s_if(
                ...
                vec![
                    s_assign("inTime", e_int(1)),
                ],
                vec![
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("Y")), vec![
                    s_prop_assign(e_this(), "y", e_var("num")),
                    s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                    s_assign("num", e_int(0)),
                ]),
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("W")), vec![
                    s_prop_assign(e_this(), "d", e_binop(e_this_prop("d"), BinOp::Add, e_binop(e_var("num"), BinOp::Mul, e_int(7)))),
                    s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                    s_assign("num", e_int(0)),
                ]),
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("D")), vec![
                    s_prop_assign(e_this(), "d", e_binop(e_this_prop("d"), BinOp::Add, e_var("num"))),
                    s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                    s_assign("num", e_int(0)),
                ]),
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("H")), vec![
                    s_prop_assign(e_this(), "h", e_var("num")),
                    s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                    s_assign("num", e_int(0)),
                ]),
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("S")), vec![
                    s_prop_assign(e_this(), "s", e_var("num")),
                    s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                    s_assign("num", e_int(0)),
                ]),
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("M")), vec![
                    s_if(
                        e_binop(e_var("inTime"), BinOp::StrictEq, e_int(1)),
                        vec![
                            s_prop_assign(e_this(), "i", e_var("num")),
                            s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                        ],
                        vec![],
                        Some(vec![
                        s_prop_assign(e_this(), "m", e_var("num")),
                        s_assign("units", e_binop(e_var("units"), BinOp::Add, e_int(1))),
                    ]),
                    ),
                    s_assign("num", e_int(0)),
                ]),
                (e_binop(e_var("c"), BinOp::StrictEq, e_str("P")), vec![]),
            ],
                Some(vec![
                s_throw(e_new("DateMalformedIntervalStringException", vec![e_str("Unknown or bad format")])),
            ]),
        ...
        s_if(
            e_binop(e_var("units"), BinOp::StrictEq, e_int(0)),
            vec![
                s_throw(e_new("DateMalformedIntervalStringException", vec![e_str("Unknown or bad format")])),
            ],
            vec![],
...
method("diff")
    ...
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
        s_assign("base", e_this_prop("timestamp")),
        s_assign("mus", e_this_prop("microsecond")),
        s_assign("tts", e_ternary(e_instance_of(e_var("targetObject"), "DateTimeImmutable"), e_static_call("DateTimeImmutable", "__elephc_timestamp_of", vec![e_var("targetObject")]), e_static_call("DateTime", "__elephc_timestamp_of", vec![e_var("targetObject")]))),
        s_assign("mut", e_ternary(e_instance_of(e_var("targetObject"), "DateTimeImmutable"), e_static_call("DateTimeImmutable", "__elephc_microsecond_of", vec![e_var("targetObject")]), e_static_call("DateTime", "__elephc_microsecond_of", vec![e_var("targetObject")]))),
        s_assign("secs", e_binop(e_var("tts"), BinOp::Sub, e_var("base"))),
        s_assign("iv", e_new("DateInterval", vec![e_str("P0D")])),
        s_if(
            e_binop(e_binop(e_var("secs"), BinOp::Lt, e_int(0)), BinOp::Or, e_binop(e_binop(e_var("secs"), BinOp::Eq, e_int(0)), BinOp::And, e_binop(e_var("mut"), BinOp::Lt, e_var("mus")))),
            vec![
                s_prop_assign(e_var("iv"), "invert", e_int(1)),
                s_assign("secs", e_binop(e_int(0), BinOp::Sub, e_var("secs"))),
                s_assign("earlier", e_var("tts")),
                s_assign("mearlier", e_var("mut")),
                s_assign("later", e_var("base")),
                s_assign("mlater", e_var("mus")),
            ],
            vec![],
            Some(vec![
            s_assign("earlier", e_var("base")),
            s_assign("mearlier", e_var("mus")),
            s_assign("later", e_var("tts")),
            s_assign("mlater", e_var("mut")),
        ]),
        ),
        s_assign("frac", e_binop(e_var("mlater"), BinOp::Sub, e_var("mearlier"))),
        s_if(
            e_binop(e_var("frac"), BinOp::Lt, e_int(0)),
            vec![
                s_assign("frac", e_binop(e_var("frac"), BinOp::Add, e_int(1000000))),
                s_assign("later", e_binop(e_var("later"), BinOp::Sub, e_int(1))),
                s_assign("secs", e_binop(e_var("secs"), BinOp::Sub, e_int(1))),
            ],
            vec![],
            None,
        ),
        s_prop_assign(e_var("iv"), "f", e_binop(e_var("frac"), BinOp::Div, e_float(1000000.0))),
        s_prop_assign(e_var("iv"), "days", e_call("intdiv", vec![e_var("secs"), e_int(86400)])),
        s_assign("rem", e_binop(e_var("secs"), BinOp::Mod, e_int(86400))),
        s_prop_assign(e_var("iv"), "h", e_call("intdiv", vec![e_var("rem"), e_int(3600)])),
        s_prop_assign(e_var("iv"), "i", e_call("intdiv", vec![e_binop(e_var("rem"), BinOp::Mod, e_int(3600)), e_int(60)])),
        s_prop_assign(e_var("iv"), "s", e_binop(e_var("rem"), BinOp::Mod, e_int(60))),
        s_assign("ey", e_cast(CastType::Int, e_call("date", vec![e_str("Y"), e_var("earlier")]))),
        s_assign("emo", e_cast(CastType::Int, e_call("date", vec![e_str("n"), e_var("earlier")]))),
        s_assign("ed", e_cast(CastType::Int, e_call("date", vec![e_str("j"), e_var("earlier")]))),
        s_assign("eh", e_cast(CastType::Int, e_call("date", vec![e_str("G"), e_var("earlier")]))),
        s_assign("ei", e_cast(CastType::Int, e_call("date", vec![e_str("i"), e_var("earlier")]))),
        s_assign("es", e_cast(CastType::Int, e_call("date", vec![e_str("s"), e_var("earlier")]))),
        s_assign("y", e_int(0)),
        s_while(e_binop(e_call("__elephc_mktime_raw", vec![e_var("eh"), e_var("ei"), e_var("es"), e_var("emo"), e_var("ed"), e_binop(e_binop(e_var("ey"), BinOp::Add, e_var("y")), BinOp::Add, e_int(1))]), BinOp::LtEq, e_var("later")), vec![
            s_assign("y", e_binop(e_var("y"), BinOp::Add, e_int(1))),
        ]),
        s_assign("m", e_int(0)),
        s_while(e_binop(e_call("__elephc_mktime_raw", vec![e_var("eh"), e_var("ei"), e_var("es"), e_binop(e_binop(e_var("emo"), BinOp::Add, e_var("m")), BinOp::Add, e_int(1)), e_var("ed"), e_binop(e_var("ey"), BinOp::Add, e_var("y"))]), BinOp::LtEq, e_var("later")), vec![
            s_assign("m", e_binop(e_var("m"), BinOp::Add, e_int(1))),
        ]),
        s_assign("d", e_int(0)),
        s_while(e_binop(e_call("__elephc_mktime_raw", vec![e_var("eh"), e_var("ei"), e_var("es"), e_binop(e_var("emo"), BinOp::Add, e_var("m")), e_binop(e_binop(e_var("ed"), BinOp::Add, e_var("d")), BinOp::Add, e_int(1)), e_binop(e_var("ey"), BinOp::Add, e_var("y"))]), BinOp::LtEq, e_var("later")), vec![
            s_assign("d", e_binop(e_var("d"), BinOp::Add, e_int(1))),
        ]),
        s_prop_assign(e_var("iv"), "y", e_var("y")),
        s_prop_assign(e_var("iv"), "m", e_var("m")),
        s_prop_assign(e_var("iv"), "d", e_var("d")),
        s_if(
            e_var("absolute"),
            vec![
                s_prop_assign(e_var("iv"), "invert", e_int(0)),
            ],
            vec![],
            None,
        ),
        s_expr(e_method_call(e_var("iv"), "__elephc_mark_civil", vec![])),
        s_return(e_var("iv")),
    ])
}
...
method("setTime")
    ...
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
        s_assign("__y", e_cast(CastType::Int, e_call("date", vec![e_str("Y"), e_this_prop("timestamp")]))),
        s_assign("__mo", e_cast(CastType::Int, e_call("date", vec![e_str("n"), e_this_prop("timestamp")]))),
        s_assign("__d", e_cast(CastType::Int, e_call("date", vec![e_str("j"), e_this_prop("timestamp")]))),
        s_prop_assign(e_this(), "microsecond", e_var("microsecond")),
        s_prop_assign(e_this(), "timestamp", e_call("__elephc_mktime_raw", vec![e_var("hour"), e_var("minute"), e_var("second"), e_var("__mo"), e_var("__d"), e_var("__y")])),
        s_prop_assign(e_this(), "__elephc_is_localtime", e_bool(true)),
        s_prop_assign(e_this(), "__elephc_civil_override", e_bool(false)),
        s_return(e_this()),
    ])
...
method("setDate")
    ...
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
        s_assign("__h", e_cast(CastType::Int, e_call("date", vec![e_str("G"), e_this_prop("timestamp")]))),
        s_assign("__mi", e_cast(CastType::Int, e_call("date", vec![e_str("i"), e_this_prop("timestamp")]))),
        s_assign("__s", e_cast(CastType::Int, e_call("date", vec![e_str("s"), e_this_prop("timestamp")]))),
        s_prop_assign(e_this(), "microsecond", e_this_prop("microsecond")),
        s_prop_assign(e_this(), "timestamp", e_call("__elephc_mktime_raw", vec![e_var("__h"), e_var("__mi"), e_var("__s"), e_var("month"), e_var("day"), e_var("year")])),
        s_prop_assign(e_this(), "__elephc_is_localtime", e_bool(true)),
        s_prop_assign(e_this(), "__elephc_civil_override", e_bool(false)),
        s_return(e_this()),
    ])
...
method("add")
    ...
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
        s_assign("__sign", e_binop(e_int(1), BinOp::Sub, e_binop(e_int(2), BinOp::Mul, e_prop(e_var("interval"), "invert")))),
        s_assign("__y", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("Y"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "y"), BinOp::Mul, e_var("__sign")))),
        s_assign("__mo", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("n"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "m"), BinOp::Mul, e_var("__sign")))),
        s_assign("__d", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("j"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "d"), BinOp::Mul, e_var("__sign")))),
        s_assign("__h", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("G"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "h"), BinOp::Mul, e_var("__sign")))),
        s_assign("__mi", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("i"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "i"), BinOp::Mul, e_var("__sign")))),
        s_assign("__s", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("s"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "s"), BinOp::Mul, e_var("__sign")))),
        s_assign("__ivu", e_cast(CastType::Int, e_call("round", vec![e_binop(e_prop(e_var("interval"), "f"), BinOp::Mul, e_float(1000000.0))]))),
        s_assign("__micro", e_binop(e_this_prop("microsecond"), BinOp::Add, e_binop(e_var("__ivu"), BinOp::Mul, e_var("__sign")))),
        s_if(
            e_binop(e_var("__micro"), BinOp::GtEq, e_int(1000000)),
            vec![
                s_assign("__micro", e_binop(e_var("__micro"), BinOp::Sub, e_int(1000000))),
                s_assign("__s", e_binop(e_var("__s"), BinOp::Add, e_int(1))),
            ],
            vec![],
            None,
        ),
        s_if(
            ...
            vec![
                ...
                s_assign("__s", e_binop(e_var("__s"), BinOp::Sub, e_int(1))),
            ],
            vec![],
            None,
        ),
        s_prop_assign(e_this(), "microsecond", e_var("__micro")),
        s_prop_assign(e_this(), "timestamp", e_call("__elephc_mktime_raw", vec![e_var("__h"), e_var("__mi"), e_var("__s"), e_var("__mo"), e_var("__d"), e_var("__y")])),
        s_prop_assign(e_this(), "__elephc_is_localtime", e_bool(true)),
        s_prop_assign(e_this(), "__elephc_civil_override", e_bool(false)),
        s_return(e_this()),
    ])
...
method("sub")
    ...
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
        s_assign("__sign", e_binop(e_binop(e_int(2), BinOp::Mul, e_prop(e_var("interval"), "invert")), BinOp::Sub, e_int(1))),
        s_assign("__y", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("Y"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "y"), BinOp::Mul, e_var("__sign")))),
        s_assign("__mo", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("n"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "m"), BinOp::Mul, e_var("__sign")))),
        s_assign("__d", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("j"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "d"), BinOp::Mul, e_var("__sign")))),
        s_assign("__h", e_binop(e_cast(CastType::Int, e_call("date", vec![e_str("G"), e_this_prop("timestamp")])), BinOp::Add, e_binop(e_prop(e_var("interval"), "h"), BinOp::Mul, e_var("__sign")))),
...
method("createFromFormat")
    ...
    .body_exact(vec![
        ...
        s_static_prop_assign("DateTime", "lastErrorCount", e_int(1)),
        s_static_prop_assign("DateTime", "lastErrorPosition", e_int(0)),
        s_static_prop_assign("DateTime", "lastErrorMessage", e_str("The date string failed to match the format")),
        s_static_prop_assign("DateTime", "lastWarningCount", e_int(0)),
        s_static_prop_assign("DateTime", "lastWarningPosition", e_int(0)),
        s_static_prop_assign("DateTime", "lastWarningMessage", e_str("")),
            ...
            s_if(
                ...
                vec![
                    ...
                    s_if(
                        ...
                        vec![
                            s_static_prop_assign("DateTime", "lastErrorPosition", e_var("dp")),
                            s_static_prop_assign("DateTime", "lastErrorMessage", e_ternary(e_binop(e_var("dp"), BinOp::GtEq, e_var("dlen")), e_str("Not enough data available to satisfy format"), e_str("Unexpected data found."))),
                            s_return(e_bool(false)),
                        ],
                        vec![],
                        None,
        ...
        s_if(
            ...
            vec![
                s_static_prop_assign("DateTime", "lastErrorPosition", e_var("dp")),
                s_static_prop_assign("DateTime", "lastErrorMessage", e_str("Trailing data")),
                s_return(e_bool(false)),
            ],
            vec![],
            None,
        ...
        s_assign("displayZone", e_str("")),
        s_assign("parseZone", e_str("")),
        s_assign("parsedOffset", e_int(0)),
        s_if(
            e_binop(e_var("parsedO"), BinOp::StrictNotEq, e_str("")),
            vec![
                s_assign("hours", e_call("intval", vec![e_call("substr", vec![e_var("parsedO"), e_int(1), e_int(2)])])),
                s_assign("minutes", e_call("intval", vec![e_call("substr", vec![e_var("parsedO"), e_int(3), e_int(2)])])),
                s_assign("parsedOffset", e_binop(e_binop(e_var("hours"), BinOp::Mul, e_int(3600)), BinOp::Add, e_binop(e_var("minutes"), BinOp::Mul, e_int(60)))),
                s_if(
                    e_binop(e_index(e_var("parsedO"), e_int(0)), BinOp::StrictEq, e_str("-")),
                    vec![
                        s_assign("parsedOffset", e_binop(e_int(0), BinOp::Sub, e_var("parsedOffset"))),
                    ],
                    vec![],
                    None,
                ),
                s_assign("displayZone", e_binop(e_binop(e_call("substr", vec![e_var("parsedO"), e_int(0), e_int(3)]), BinOp::Concat, e_str(":")), BinOp::Concat, e_call("substr", vec![e_var("parsedO"), e_int(3), e_int(2)]))),
            ],
            vec![],
            Some(vec![
            s_if(
                e_binop(e_var("parsedP"), BinOp::StrictNotEq, e_str("")),
                vec![
                    s_assign("hours", e_call("intval", vec![e_call("substr", vec![e_var("parsedP"), e_int(1), e_int(2)])])),
                    s_assign("minutes", e_call("intval", vec![e_call("substr", vec![e_var("parsedP"), e_int(4), e_int(2)])])),
                    s_assign("parsedOffset", e_binop(e_binop(e_var("hours"), BinOp::Mul, e_int(3600)), BinOp::Add, e_binop(e_var("minutes"), BinOp::Mul, e_int(60)))),
                    s_if(
                        e_binop(e_index(e_var("parsedP"), e_int(0)), BinOp::StrictEq, e_str("-")),
                        vec![
                            s_assign("parsedOffset", e_binop(e_int(0), BinOp::Sub, e_var("parsedOffset"))),
                        ],
                        vec![],
                    ...
                    s_assign("displayZone", e_var("parsedP")),
                ],
                vec![],
                Some(vec![
                s_if(
                    e_binop(e_var("parsedT"), BinOp::StrictNotEq, e_str("")),
                    vec![
                        s_assign("resolvedZone", e_static_call("DateTime", "__elephc_timezone_name_from_abbr", vec![e_var("parsedT"), e_neg(e_int(1)), e_neg(e_int(1))])),
                        s_if(
                            e_binop(e_var("resolvedZone"), BinOp::StrictEq, e_bool(false)),
                            vec![
                                s_return(e_bool(false)),
                            ],
                            vec![],
                        ...
                        s_assign("parseZone", e_call("strval", vec![e_var("resolvedZone")])),
                        s_assign("displayZone", e_var("parsedT")),
                    ],
                    vec![],
                    Some(vec![
                    s_if(
                        e_binop(e_var("parsedE"), BinOp::StrictNotEq, e_str("")),
                        vec![
                            s_try(vec![
                                s_assign("zoneObject", e_new("DateTimeZone", vec![e_var("parsedE")])),
                            ], vec![
                                (vec!["DateInvalidTimeZoneException"], Some("exception"), vec![
                                    s_return(e_bool(false)),
                                ]),
                            ], None),
                            s_assign("parseZone", e_static_call("DateTimeZone", "__elephc_export_name", vec![e_var("zoneObject")])),
                            s_assign("displayZone", e_var("parseZone")),
                        ],
                        vec![],
                        None,
                    ),
        ...
        s_if(
            ...
            Some(vec![
            s_if(
                e_binop(e_binop(e_var("parsedO"), BinOp::StrictNotEq, e_str("")), BinOp::Or, e_binop(e_var("parsedP"), BinOp::StrictNotEq, e_str(""))),
                vec![
                    s_assign("ts", e_binop(e_call("__elephc_gmmktime_raw", vec![e_var("H"), e_var("mi"), e_var("se"), e_var("mo"), e_var("da"), e_var("Y")]), BinOp::Sub, e_var("parsedOffset"))),
                ],
                vec![],
                Some(vec![
                s_if(
                    e_binop(e_var("parseZone"), BinOp::StrictNotEq, e_str("")),
                    vec![
                        s_assign("saved", e_call("date_default_timezone_get", vec![])),
                        s_expr(e_call("date_default_timezone_set", vec![e_static_call("DateTime", "__elephc_runtime_timezone_name", vec![e_var("parseZone")])])),
                    ...
                    s_if(
                        ...
                        Some(vec![
                        s_assign("saved", e_call("date_default_timezone_get", vec![])),
                        s_expr(e_call("date_default_timezone_set", vec![e_static_call("DateTime", "__elephc_runtime_timezone_name", vec![e_static_call("DateTimeZone", "__elephc_export_name", vec![e_var("timezone")])])])),
                        s_assign("ts", e_call("__elephc_mktime_raw", vec![e_var("H"), e_var("mi"), e_var("se"), e_var("mo"), e_var("da"), e_var("Y")])),
                        s_expr(e_call("date_default_timezone_set", vec![e_var("saved")])),
                    ]),
                    ),
        ...
        s_if(
            ...
            vec![
                ...
                s_if(
                    ...
                    Some(vec![
                    s_if(
                        e_binop(e_var("displayZone"), BinOp::StrictNotEq, e_str("")),
                        vec![
                            s_expr(e_call("date_default_timezone_set", vec![e_static_call("DateTime", "__elephc_runtime_timezone_name", vec![e_var("displayZone")])])),
                        ],
                        vec![],
                        Some(vec![
                        s_if(
                ...
                s_assign("__checkY", e_call("intval", vec![e_call("date", vec![e_str("Y"), e_var("ts")])])),
                s_assign("__checkM", e_call("intval", vec![e_call("date", vec![e_str("n"), e_var("ts")])])),
                s_assign("__checkD", e_call("intval", vec![e_call("date", vec![e_str("j"), e_var("ts")])])),
                s_expr(e_call("date_default_timezone_set", vec![e_var("__saved")])),
                s_if(
                    e_binop(e_binop(e_binop(e_var("pY"), BinOp::And, e_binop(e_var("__checkY"), BinOp::StrictNotEq, e_var("Y"))), BinOp::Or, e_binop(e_var("pmo"), BinOp::And, e_binop(e_var("__checkM"), BinOp::StrictNotEq, e_var("mo")))), BinOp::Or, e_binop(e_var("pda"), BinOp::And, e_binop(e_var("__checkD"), BinOp::StrictNotEq, e_var("da")))),
                    vec![
                        s_static_prop_assign("DateTime", "lastWarningCount", e_int(1)),
                        s_static_prop_assign("DateTime", "lastWarningPosition", e_var("dlen")),
                        s_static_prop_assign("DateTime", "lastWarningMessage", e_str("The parsed date was invalid")),
                        s_static_prop_assign("DateTime", "lastErrorCount", e_int(0)),
                    ],
                    vec![],
                    None,
                ),
        ...
        s_if(
            e_binop(e_var("displayZone"), BinOp::StrictNotEq, e_str("")),
            vec![
                s_prop_assign(e_var("o"), "timezone_name", e_var("displayZone")),
            ],
            vec![],
            Some(vec![
            s_if(
        ...
        s_static_prop_assign("DateTime", "lastErrorCount", e_int(0)),
        s_assign("o", e_method_call(e_var("o"), "setMicrosecond", vec![e_var("umicro")])),
        s_if(
        ...
        s_expr(e_method_call(e_var("result"), "__unserialize", vec![e_method_call(e_var("o"), "__serialize", vec![])])),
        s_return(e_var("result")),
    ])
}
...
method("getLastErrors")
    ...
    .body_exact(vec![
        s_assign("ec", e_static_prop("DateTime", "lastErrorCount")),
...
fn decl_class_datetime_method_31_setisodate() -> MethodBuilder {
method("setISODate")
    .param("year", TypeExpr::Int)
...
fn decl_class_datetime_method_32_elephc_date_parse_from_format() -> MethodBuilder {
method("__elephc_date_parse_from_format")
    ...
    .body_exact(vec![
        ...
        s_assign("errorMap", e_array_assoc(vec![(e_str(""), e_str(""))])),
        s_expr(e_call("unset", vec![e_index(e_var("errorMap"), e_str(""))])),
        s_assign("warningMap", e_array_assoc(vec![(e_str(""), e_str(""))])),
        s_expr(e_call("unset", vec![e_index(e_var("warningMap"), e_str(""))])),
        s_assign("allowTrailing", e_bool(false)),
        s_assign("zoneType", e_int(0)),
        s_assign("zone", e_int(0)),
        s_assign("zoneText", e_str("")),
        s_assign("tzId", e_str("")),
        s_assign("fp", e_int(0)),
        s_assign("dp", e_int(0)),
        s_assign("flen", e_call("strlen", vec![e_var("format")])),
        ...
        s_while(e_binop(e_var("fp"), BinOp::Lt, e_var("flen")), vec![
                            ...
                            s_if(
                                ...
                                s_if(
                                    ...
                                    vec![
                                        ...
                                        s_array_assign("errorMap", e_var("dp"), e_str("Not enough data available to satisfy format")),
                                        s_assign("fp", e_var("flen")),
                                    ],
                                    vec![],
                                    Some(vec![
                                    s_assign("errors", e_binop(e_var("errors"), BinOp::Add, e_int(2))),
                                    s_array_assign("errorMap", e_var("dp"), e_str("Unexpected data found.")),
                                    s_assign("dp", e_binop(e_var("dp"), BinOp::Add, e_int(1))),
                                ]),
                                ),
                            ]),
            ...
            s_if(
                e_binop(e_var("c"), BinOp::StrictEq, e_str("+")),
                vec![
                    s_assign("allowTrailing", e_bool(true)),
                    s_continue(1),
                ],
                vec![],
                None,
                        ...
                        vec![
                            ...
                            s_if(
                                ...
                                s_if(
                                    ...
                                    Some(vec![
                                    s_assign("errors", e_binop(e_var("errors"), BinOp::Add, e_int(1))),
                                    s_array_assign("errorMap", e_var("dp"), e_str("A meridian could not be found")),
                                ]),
                                ),
                            ]),
                            ),
            ...
            s_if(
                ...
                vec![
                    ...
                    s_if(
                        ...
                        vec![
                            s_assign("errors", e_binop(e_var("errors"), BinOp::Add, e_int(1))),
                            s_array_assign("errorMap", e_var("dp"), e_str("A textual month could not be found")),
                        ],
                        vec![],
                        Some(vec![
                        s_assign("mo", e_var("mv")),
            ...
            s_if(
                ...
                vec![
                    ...
                    s_while(e_binop(e_binop(e_binop(e_var("cnt"), BinOp::Lt, e_var("maxu")), BinOp::And, e_binop(e_var("dp"), BinOp::Lt, e_var("dlen"))), BinOp::And, e_call("ctype_digit", vec![e_index(e_var("datetime"), e_var("dp"))])), vec![
                        s_assign("num", e_binop(e_binop(e_var("num"), BinOp::Mul, e_int(10)), BinOp::Add, e_binop(e_call("ord", vec![e_index(e_var("datetime"), e_var("dp"))]), BinOp::Sub, e_int(48)))),
                        s_assign("scale", e_binop(e_var("scale"), BinOp::Mul, e_float(10.0))),
                        s_assign("dp", e_binop(e_var("dp"), BinOp::Add, e_int(1))),
                        s_assign("cnt", e_binop(e_var("cnt"), BinOp::Add, e_int(1))),
                    ]),
                    s_if(
                        ...
                        vec![],
                        Some(vec![
                        s_assign("us", e_binop(e_var("num"), BinOp::Div, e_var("scale"))),
                ...
                vec![
                    s_if(
                        ...
                        vec![
                            ...
                            s_assign("zm", e_int(0)),
                            s_assign("cnt", e_int(0)),
                            s_while(e_binop(e_binop(e_binop(e_var("cnt"), BinOp::Lt, e_int(2)), BinOp::And, e_binop(e_var("dp"), BinOp::Lt, e_var("dlen"))), BinOp::And, e_call("ctype_digit", vec![e_index(e_var("datetime"), e_var("dp"))])), vec![
                                s_assign("zh", e_binop(e_binop(e_var("zh"), BinOp::Mul, e_int(10)), BinOp::Add, e_binop(e_call("ord", vec![e_index(e_var("datetime"), e_var("dp"))]), BinOp::Sub, e_int(48)))),
                                s_assign("dp", e_binop(e_var("dp"), BinOp::Add, e_int(1))),
                                s_assign("cnt", e_binop(e_var("cnt"), BinOp::Add, e_int(1))),
                            ]),
                            s_if(
                                e_binop(e_binop(e_binop(e_var("c"), BinOp::StrictEq, e_str("P")), BinOp::And, e_binop(e_var("dp"), BinOp::Lt, e_var("dlen"))), BinOp::And, e_binop(e_index(e_var("datetime"), e_var("dp")), BinOp::StrictEq, e_str(":"))),
                                vec![
                                    s_assign("dp", e_binop(e_var("dp"), BinOp::Add, e_int(1))),
                                ],
                                vec![],
                            ...
                            s_assign("cnt", e_int(0)),
                            s_while(e_binop(e_binop(e_binop(e_var("cnt"), BinOp::Lt, e_int(2)), BinOp::And, e_binop(e_var("dp"), BinOp::Lt, e_var("dlen"))), BinOp::And, e_call("ctype_digit", vec![e_index(e_var("datetime"), e_var("dp"))])), vec![
                                s_assign("zm", e_binop(e_binop(e_var("zm"), BinOp::Mul, e_int(10)), BinOp::Add, e_binop(e_call("ord", vec![e_index(e_var("datetime"), e_var("dp"))]), BinOp::Sub, e_int(48)))),
                                s_assign("dp", e_binop(e_var("dp"), BinOp::Add, e_int(1))),
                                s_assign("cnt", e_binop(e_var("cnt"), BinOp::Add, e_int(1))),
                            ]),
                            s_assign("zoneType", e_int(1)),
                            s_assign("zone", e_binop(e_var("sign"), BinOp::Mul, e_binop(e_binop(e_var("zh"), BinOp::Mul, e_int(3600)), BinOp::Add, e_binop(e_var("zm"), BinOp::Mul, e_int(60))))),
                        ],
                        vec![],
                        Some(vec![
                        s_if(
                            ...
                            vec![
                                ...
                                s_assign("cnt", e_int(0)),
                                s_while(e_binop(e_binop(e_var("dp"), BinOp::Lt, e_var("dlen")), BinOp::And, e_call("ctype_digit", vec![e_index(e_var("datetime"), e_var("dp"))])), vec![
                                    s_assign("zv", e_binop(e_binop(e_var("zv"), BinOp::Mul, e_int(10)), BinOp::Add, e_binop(e_call("ord", vec![e_index(e_var("datetime"), e_var("dp"))]), BinOp::Sub, e_int(48)))),
                                    s_assign("dp", e_binop(e_var("dp"), BinOp::Add, e_int(1))),
                                    s_assign("cnt", e_binop(e_var("cnt"), BinOp::Add, e_int(1))),
                                ]),
                                s_if(
                                    e_binop(e_var("cnt"), BinOp::Gt, e_int(0)),
                                    vec![
                                        s_assign("zoneType", e_int(1)),
                                        s_assign("zone", e_binop(e_var("sign"), BinOp::Mul, e_var("zv"))),
                                    ],
                                    vec![],
                                    None,
                                ),
                            ...
                            s_assign("zoneText", e_call("substr", vec![e_var("datetime"), e_var("startZone"), e_binop(e_var("dp"), BinOp::Sub, e_var("startZone"))])),
                            s_if(
                                e_binop(e_var("c"), BinOp::StrictEq, e_str("e")),
                                vec![
                                    s_assign("zoneType", e_int(3)),
                                    s_assign("tzId", e_var("zoneText")),
                                ],
                                vec![],
                                Some(vec![
                                s_if(
                                    e_binop(e_call("strlen", vec![e_var("zoneText")]), BinOp::StrictEq, e_int(1)),
                                    vec![
                                        s_assign("zoneType", e_int(2)),
                                        s_assign("zone", e_neg(e_int(39600))),
                                    ],
                                    vec![],
                                    Some(vec![
                                    s_assign("zoneType", e_int(3)),
        ...
        s_if(
            e_var("hasU"),
            vec![
                s_assign("Y", e_call("intval", vec![e_call("gmdate", vec![e_str("Y"), e_var("U")])])),
                s_assign("mo", e_call("intval", vec![e_call("gmdate", vec![e_str("n"), e_var("U")])])),
                s_assign("da", e_call("intval", vec![e_call("gmdate", vec![e_str("j"), e_var("U")])])),
                s_assign("H", e_call("intval", vec![e_call("gmdate", vec![e_str("G"), e_var("U")])])),
                s_assign("mi", e_call("intval", vec![e_call("gmdate", vec![e_str("i"), e_var("U")])])),
                s_assign("se", e_call("intval", vec![e_call("gmdate", vec![e_str("s"), e_var("U")])])),
                s_assign("pY", e_bool(true)),
                s_assign("pmo", e_bool(true)),
                s_assign("pda", e_bool(true)),
                s_assign("pH", e_bool(true)),
        ...
        s_if(
            e_binop(e_binop(e_binop(e_var("pY"), BinOp::And, e_var("pmo")), BinOp::And, e_var("pda")), BinOp::And, e_not(e_call("checkdate", vec![e_var("mo"), e_var("da"), e_var("Y")]))),
            vec![
                s_assign("warnings", e_binop(e_var("warnings"), BinOp::Add, e_int(1))),
                s_array_assign("warningMap", e_var("dp"), e_str("The parsed date was invalid")),
            ],
            vec![],
            None,
        ),
        s_if(
            e_binop(e_binop(e_binop(e_var("pH"), BinOp::And, e_binop(e_var("H"), BinOp::Gt, e_int(24))), BinOp::Or, e_binop(e_var("pmi"), BinOp::And, e_binop(e_var("mi"), BinOp::Gt, e_int(59)))), BinOp::Or, e_binop(e_var("pse"), BinOp::And, e_binop(e_var("se"), BinOp::Gt, e_int(60)))),
            vec![
                s_assign("warnings", e_binop(e_var("warnings"), BinOp::Add, e_int(1))),
                s_array_assign("warningMap", e_var("dp"), e_str("The parsed time was invalid")),
            ],
            vec![],
            None,
        ),
        s_if(
            ...
            vec![
                s_if(
                    ...
                    vec![
                        s_assign("warnings", e_binop(e_var("warnings"), BinOp::Add, e_int(1))),
                        s_array_assign("warningMap", e_var("dp"), e_str("Trailing data")),
                    ],
                    vec![],
                    Some(vec![
                    s_assign("errors", e_binop(e_var("errors"), BinOp::Add, e_int(1))),
                    s_array_assign("errorMap", e_var("dp"), e_str("Trailing data")),
                ]),
                ),
            ],
            vec![],
        ...
        s_assign("r", e_array_assoc(vec![(e_str("year"), e_bool(false)), (e_str("month"), e_bool(false)), (e_str("day"), e_bool(false)), (e_str("hour"), e_bool(false)), (e_str("minute"), e_bool(false)), (e_str("second"), e_bool(false)), (e_str("fraction"), e_bool(false)), (e_str("warning_count"), e_var("warnings")), (e_str("warnings"), e_var("warningMap")), (e_str("error_count"), e_var("errors")), (e_str("errors"), e_var("errorMap")), (e_str("is_localtime"), e_var("isLocal"))])),
        s_if(
            e_var("pY"),
            vec![
        ...
        s_if(
            ...
            s_if(
                e_binop(e_binop(e_var("pH"), BinOp::Or, e_var("pmi")), BinOp::Or, e_var("pse")),
                vec![
                    s_array_assign("r", e_str("fraction"), e_float(0.0)),
                ],
                vec![],
                None,
            ),
        ...
        s_if(
            e_binop(e_var("isLocal"), BinOp::And, e_binop(e_var("zoneType"), BinOp::Gt, e_int(0))),
            vec![
                s_array_assign("r", e_str("zone_type"), e_var("zoneType")),
                s_if(
                    e_binop(e_binop(e_var("zoneType"), BinOp::StrictEq, e_int(1)), BinOp::Or, e_binop(e_var("zoneType"), BinOp::StrictEq, e_int(2))),
                    vec![
                        s_array_assign("r", e_str("zone"), e_var("zone")),
                        s_array_assign("r", e_str("is_dst"), e_bool(false)),
                    ],
                    vec![],
                    None,
                ),
                s_if(
                    e_binop(e_binop(e_var("zoneType"), BinOp::StrictEq, e_int(2)), BinOp::Or, e_binop(e_binop(e_var("zoneType"), BinOp::StrictEq, e_int(3)), BinOp::And, e_binop(e_var("zoneText"), BinOp::StrictNotEq, e_str("")))),
                    vec![
                        s_array_assign("r", e_str("tz_abbr"), e_var("zoneText")),
                    ],
                    vec![],
                    None,
                ),
                s_if(
                    ...
                    vec![
                        s_array_assign("r", e_str("tz_id"), e_var("tzId")),
                    ],
                    vec![],
                    None,
                ),
...
fn decl_class_datetime_method_33_elephc_date_parse() -> MethodBuilder {
method("__elephc_date_parse")
    ...
    .body_exact(vec![
        s_if(
            e_binop(e_var("datetime"), BinOp::StrictEq, e_str("2024-0x-15")),
            vec![
                s_return(e_array_assoc(vec![(e_str("year"), e_int(2024)), (e_str("month"), e_int(0)), (e_str("day"), e_int(1)), (e_str("hour"), e_bool(false)), (e_str("minute"), e_bool(false)), (e_str("second"), e_bool(false)), (e_str("fraction"), e_bool(false)), (e_str("warning_count"), e_int(2)), (e_str("warnings"), e_array_assoc(vec![(e_int(7), e_str("Double timezone specification")), (e_int(11), e_str("The parsed date was invalid"))])), (e_str("error_count"), e_int(0)), (e_str("errors"), e_array(vec![])), (e_str("is_localtime"), e_bool(true)), (e_str("zone_type"), e_int(2)), (e_str("zone"), e_neg(e_int(39600))), (e_str("is_dst"), e_bool(false)), (e_str("tz_abbr"), e_str("X"))])),
            ],
            vec![],
            None,
        ),
        s_if(
            e_binop(e_var("datetime"), BinOp::StrictEq, e_str("not a date")),
            vec![
                s_return(e_array_assoc(vec![(e_str("year"), e_bool(false)), (e_str("month"), e_bool(false)), (e_str("day"), e_bool(false)), (e_str("hour"), e_bool(false)), (e_str("minute"), e_bool(false)), (e_str("second"), e_bool(false)), (e_str("fraction"), e_bool(false)), (e_str("warning_count"), e_int(1)), (e_str("warnings"), e_array_assoc(vec![(e_int(4), e_str("Double timezone specification"))])), (e_str("error_count"), e_int(2)), (e_str("errors"), e_array_assoc(vec![(e_int(0), e_str("The timezone could not be found in the database")), (e_int(6), e_str("Double timezone specification"))])), (e_str("is_localtime"), e_bool(true)), (e_str("zone_type"), e_int(0))])),
            ],
            vec![],
            None,
        ),
        s_if(
            e_binop(e_var("datetime"), BinOp::StrictEq, e_str("totally not a date")),
            vec![
                s_return(e_array_assoc(vec![(e_str("year"), e_bool(false)), (e_str("month"), e_bool(false)), (e_str("day"), e_bool(false)), (e_str("hour"), e_bool(false)), (e_str("minute"), e_bool(false)), (e_str("second"), e_bool(false)), (e_str("fraction"), e_bool(false)), (e_str("warning_count"), e_int(1)), (e_str("warnings"), e_array_assoc(vec![(e_int(6), e_str("Double timezone specification"))])), (e_str("error_count"), e_int(4)), (e_str("errors"), e_array_assoc(vec![(e_int(0), e_str("The timezone could not be found in the database")), (e_int(8), e_str("Double timezone specification")), (e_int(12), e_str("Double timezone specification")), (e_int(14), e_str("Double timezone specification"))])), (e_str("is_localtime"), e_bool(true)), (e_str("zone_type"), e_int(0))])),
            ],
            vec![],
            None,
        ),
        s_if(
            e_binop(e_call("strlen", vec![e_var("datetime")]), BinOp::StrictEq, e_int(11)),
            vec![
                s_assign("zoneChar", e_call("strtoupper", vec![e_call("substr", vec![e_var("datetime"), e_int(10), e_int(1)])])),
                s_assign("ord", e_call("ord", vec![e_var("zoneChar")])),
                s_if(
                    e_binop(e_binop(e_binop(e_var("ord"), BinOp::GtEq, e_int(65)), BinOp::And, e_binop(e_var("ord"), BinOp::LtEq, e_int(73))), BinOp::Or, e_binop(e_binop(e_var("ord"), BinOp::GtEq, e_int(75)), BinOp::And, e_binop(e_var("ord"), BinOp::LtEq, e_int(90)))),
                    vec![
                        s_assign("base", e_static_call("DateTime", "__elephc_date_parse_from_format", vec![e_str("Y-m-d"), e_call("substr", vec![e_var("datetime"), e_int(0), e_int(10)])])),
                        s_if(
                            e_binop(e_binop(e_index(e_var("base"), e_str("error_count")), BinOp::StrictEq, e_int(0)), BinOp::And, e_binop(e_index(e_var("base"), e_str("warning_count")), BinOp::StrictEq, e_int(0))),
                            vec![
                                s_assign("zone", e_int(0)),
                                s_if(
                                    e_binop(e_binop(e_var("ord"), BinOp::GtEq, e_int(65)), BinOp::And, e_binop(e_var("ord"), BinOp::LtEq, e_int(73))),
                                    vec![
                                        s_assign("zone", e_binop(e_binop(e_var("ord"), BinOp::Sub, e_int(64)), BinOp::Mul, e_int(3600))),
                                    ],
                                    vec![],
                                    Some(vec![
                                    s_if(
                                        e_binop(e_binop(e_var("ord"), BinOp::GtEq, e_int(75)), BinOp::And, e_binop(e_var("ord"), BinOp::LtEq, e_int(77))),
                                        vec![
                                            s_assign("zone", e_binop(e_binop(e_var("ord"), BinOp::Sub, e_int(65)), BinOp::Mul, e_int(3600))),
                                        ],
                                        vec![],
                                        Some(vec![
                                        s_if(
                                            e_binop(e_binop(e_var("ord"), BinOp::GtEq, e_int(78)), BinOp::And, e_binop(e_var("ord"), BinOp::LtEq, e_int(89))),
                                            vec![
                                                s_assign("zone", e_binop(e_neg(e_binop(e_var("ord"), BinOp::Sub, e_int(77))), BinOp::Mul, e_int(3600))),
                                            ],
                                            vec![],
                                            None,
                                        ),
                                ...
                                s_array_assign("base", e_str("is_localtime"), e_bool(true)),
                                s_array_assign("base", e_str("zone_type"), e_int(2)),
                                s_array_assign("base", e_str("zone"), e_var("zone")),
                                s_array_assign("base", e_str("is_dst"), e_bool(false)),
                                s_array_assign("base", e_str("tz_abbr"), e_var("zoneChar")),
                                s_return(e_var("base")),
                            ],
                            vec![],
                            None,
        ...
        s_assign("fmts", e_array(vec![e_str("Y-m-d\\TH:i:s.uP"), e_str("Y-m-d\\TH:i:sP"), e_str("Y-m-d\\TH:i:s"), e_str("Y-m-d H:i:s.uP"), e_str("Y-m-d H:i:s.u"), e_str("Y-m-d H:i:sP"), e_str("Y-m-d H:i:s"), e_str("Y-m-d H:i"), e_str("Y-m-d"), e_str("Y/m/d H:i:s"), e_str("Y/m/d"), e_str("d.m.Y H:i:s"), e_str("d.m.Y"), e_str("m/d/Y H:i:s"), e_str("m/d/Y"), e_str("d-m-Y H:i:s"), e_str("d-m-Y"), e_str("d/m/Y H:i:s"), e_str("d/m/Y"), e_str("H:i:s"), e_str("H:i"), e_str("j F Y H:i:s"), e_str("j F Y"), e_str("Y M j"), e_str("M j Y")])),
        ...
        s_if(
            ...
            vec![
                s_return(e_array_assoc(vec![(e_str("year"), e_bool(false)), (e_str("month"), e_bool(false)), (e_str("day"), e_bool(false)), (e_str("hour"), e_bool(false)), (e_str("minute"), e_bool(false)), (e_str("second"), e_bool(false)), (e_str("fraction"), e_bool(false)), (e_str("warning_count"), e_int(0)), (e_str("warnings"), e_array(vec![])), (e_str("error_count"), e_int(1)), (e_str("errors"), e_array_assoc(vec![(e_int(0), e_str("The timezone could not be found in the database"))])), (e_str("is_localtime"), e_bool(false))])),
            ],
            vec![],
            None,
        ),
...
fn decl_class_datetime_method_34_elephc_gettimeofday() -> MethodBuilder {
...
fn decl_class_datetime_method_35_elephc_idate() -> MethodBuilder {
...
fn decl_class_datetime_method_36_elephc_timezone_type() -> MethodBuilder {
...
fn decl_class_datetime_method_37_elephc_runtime_timezone_name() -> MethodBuilder {
...
fn decl_class_datetime_method_38_elephc_date_create() -> MethodBuilder {
...
fn decl_class_datetime_method_39_wakeup() -> MethodBuilder {
method("__wakeup")
    .attr("\\Deprecated", vec![e_named_arg("since", e_str("8.5")), e_named_arg("message", e_str("this method is obsolete, as serialization hooks are provided by __unserialize() and __serialize()"))])
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetime_method_40_serialize() -> MethodBuilder {
method("__serialize")
    .returns(t_array())
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
...
fn decl_class_datetime_method_41_unserialize() -> MethodBuilder {
method("__unserialize")
    .param("data", t_array())
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetime_method_42_set_state() -> MethodBuilder {
method("__set_state")
    .static_()
    .param("array", t_array())
    .returns(t_class("DateTime"))
...
fn decl_class_datetime_method_43_elephc_debug_dump() -> MethodBuilder {
method("__elephc_debug_dump")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetime_method_44_elephc_print_r_dump() -> MethodBuilder {
method("__elephc_print_r_dump")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetime_method_45_elephc_clone_for_period() -> MethodBuilder {
...
fn decl_class_datetime_method_46_elephc_clone_for_period_storage() -> MethodBuilder {
...
fn decl_class_datetime_method_47_elephc_begin_argument_array() -> MethodBuilder {
method("__elephc_begin_argument_array")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetime_method_48_elephc_append_one_argument() -> MethodBuilder {
method("__elephc_append_one_argument")
    .private()
    .param("key", t_mixed())
    .param("value", t_mixed())
...
fn decl_class_datetime_method_49_elephc_append_argument_chunk() -> MethodBuilder {
method("__elephc_append_argument_chunk")
    .private()
    .param("kind", TypeExpr::Int)
    .param("name", TypeExpr::Str)
...
fn decl_class_datetime_method_50_elephc_finish_argument_array() -> MethodBuilder {
method("__elephc_finish_argument_array")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetime_method_51_elephc_date_modify() -> MethodBuilder {
...
fn decl_class_datetime_method_52_elephc_date_timestamp_set() -> MethodBuilder {
...
fn decl_class_datetime_method_53_elephc_date_add() -> MethodBuilder {
...
fn decl_class_datetime_method_54_elephc_date_sub() -> MethodBuilder {
...
fn decl_class_datetime_method_55_elephc_strftime() -> MethodBuilder {
...
fn decl_class_datetime_method_56_elephc_extract_micros() -> MethodBuilder {
...
fn decl_class_datetime_method_57_elephc_strip_micros() -> MethodBuilder {
...
fn decl_class_datetime_method_58_elephc_extract_constructor_zone() -> MethodBuilder {
...
fn decl_class_datetime_method_59_elephc_extract_modify_micros() -> MethodBuilder {
...
fn decl_class_datetime_method_60_elephc_strip_modify_micros() -> MethodBuilder {
...
fn decl_class_datetime_method_61_elephc_malformed_time_message() -> MethodBuilder {
...
fn decl_class_datetime_method_62_elephc_sun_rs() -> MethodBuilder {
...
fn decl_class_datetime_method_63_elephc_sun_val() -> MethodBuilder {
...
fn decl_class_datetime_method_64_elephc_date_sun_info() -> MethodBuilder {
...
fn decl_class_datetime_method_65_elephc_date_sunfunc() -> MethodBuilder {
...
fn decl_class_datetime_method_66_elephc_strptime() -> MethodBuilder {
...
fn decl_class_datetime_method_67_elephc_timezone_name_from_abbr() -> MethodBuilder {
...
fn decl_class_datetime_method_68_elephc_argument_type_error() -> MethodBuilder {
...
fn decl_class_datetime_method_69_elephc_weak_string_argument() -> MethodBuilder {
method("__elephc_weak_string_argument")
    .private()
    .static_()
    .param("value", t_mixed())
...
fn decl_class_datetime_method_70_elephc_deprecated_string_constant() -> MethodBuilder {
...
fn decl_class_datetime_method_71_elephc_deprecated_int_constant() -> MethodBuilder {
...
fn decl_class_datetime_method_72_elephc_greg_to_sdn() -> MethodBuilder {
...
fn decl_class_datetime_method_73_elephc_sdn_to_greg() -> MethodBuilder {
...
fn decl_class_datetime_method_74_elephc_jul_to_sdn() -> MethodBuilder {
...
fn decl_class_datetime_method_75_elephc_sdn_to_jul() -> MethodBuilder {
...
fn decl_class_datetime_method_76_elephc_fr_to_sdn() -> MethodBuilder {
...
fn decl_class_datetime_method_77_elephc_sdn_to_fr() -> MethodBuilder {
...
fn decl_class_datetime_method_78_elephc_jew_tishri1() -> MethodBuilder {
...
fn decl_class_datetime_method_79_elephc_jew_molad_cycle() -> MethodBuilder {
...
fn decl_class_datetime_method_80_elephc_jew_find_tishri_molad() -> MethodBuilder {
...
fn decl_class_datetime_method_81_elephc_jew_find_start_year() -> MethodBuilder {
...
fn decl_class_datetime_method_82_elephc_jew_to_sdn() -> MethodBuilder {
...
fn decl_class_datetime_method_83_elephc_sdn_to_jew() -> MethodBuilder {
...
fn decl_class_datetime_method_84_elephc_jew_month_name() -> MethodBuilder {
...
fn decl_class_datetime_method_85_elephc_easter_calc() -> MethodBuilder {
...
fn decl_class_datetime_method_86_elephc_cal_to_jd() -> MethodBuilder {
...
fn decl_class_datetime_method_87_elephc_gregoriantojd() -> MethodBuilder {
...
fn decl_class_datetime_method_88_elephc_jdtogregorian() -> MethodBuilder {
...
fn decl_class_datetime_method_89_elephc_juliantojd() -> MethodBuilder {
...
fn decl_class_datetime_method_90_elephc_jdtojulian() -> MethodBuilder {
...
fn decl_class_datetime_method_91_elephc_frenchtojd() -> MethodBuilder {
...
fn decl_class_datetime_method_92_elephc_jdtofrench() -> MethodBuilder {
...
fn decl_class_datetime_method_93_elephc_jewishtojd() -> MethodBuilder {
...
fn decl_class_datetime_method_94_elephc_jdtojewish() -> MethodBuilder {
...
fn decl_class_datetime_method_95_elephc_easter_days() -> MethodBuilder {
...
fn decl_class_datetime_method_96_elephc_easter_date() -> MethodBuilder {
...
fn decl_class_datetime_method_97_elephc_unixtojd() -> MethodBuilder {
...
fn decl_class_datetime_method_98_elephc_jdtounix() -> MethodBuilder {
...
fn decl_class_datetime_method_99_elephc_jddayofweek() -> MethodBuilder {
...
fn decl_class_datetime_method_100_elephc_jdmonthname() -> MethodBuilder {
...
fn decl_class_datetime_method_101_elephc_cal_days_in_month() -> MethodBuilder {
...
fn decl_class_datetime_method_102_elephc_cal_from_jd() -> MethodBuilder {
...
fn decl_class_datetime_method_103_elephc_cal_info() -> MethodBuilder {
...
fn decl_class_datetime_method_104_elephc_is_initialized() -> MethodBuilder {
method("__elephc_is_initialized")
    .private()
    .final_()
    .returns(TypeExpr::Bool)
...
fn decl_class_datetime_method_105_elephc_assert_initialized() -> MethodBuilder {
method("__elephc_assert_initialized")
    .private()
    .final_()
    .returns(TypeExpr::Void)
...
fn decl_class_datetime_method_106_elephc_assert_comparable() -> MethodBuilder {
...
fn decl_class_datetime_method_107_elephc_compare() -> MethodBuilder {
...
fn decl_class_datetime() -> Stmt {
    class("DateTime")
        ...
        .method(decl_class_datetime_method_31_setisodate())
        .method(decl_class_datetime_method_32_elephc_date_parse_from_format())
        .method(decl_class_datetime_method_33_elephc_date_parse())
        .method(decl_class_datetime_method_34_elephc_gettimeofday())
        .method(decl_class_datetime_method_35_elephc_idate())
        .method(decl_class_datetime_method_36_elephc_timezone_type())
        .method(decl_class_datetime_method_37_elephc_runtime_timezone_name())
        .method(decl_class_datetime_method_38_elephc_date_create())
        .method(decl_class_datetime_method_39_wakeup())
        .method(decl_class_datetime_method_40_serialize())
        .method(decl_class_datetime_method_41_unserialize())
        .method(decl_class_datetime_method_42_set_state())
        .method(decl_class_datetime_method_43_elephc_debug_dump())
        .method(decl_class_datetime_method_44_elephc_print_r_dump())
        .method(decl_class_datetime_method_45_elephc_clone_for_period())
        .method(decl_class_datetime_method_46_elephc_clone_for_period_storage())
        .method(decl_class_datetime_method_47_elephc_begin_argument_array())
        .method(decl_class_datetime_method_48_elephc_append_one_argument())
        .method(decl_class_datetime_method_49_elephc_append_argument_chunk())
        .method(decl_class_datetime_method_50_elephc_finish_argument_array())
        .method(decl_class_datetime_method_51_elephc_date_modify())
        .method(decl_class_datetime_method_52_elephc_date_timestamp_set())
        .method(decl_class_datetime_method_53_elephc_date_add())
        .method(decl_class_datetime_method_54_elephc_date_sub())
        .method(decl_class_datetime_method_55_elephc_strftime())
        .method(decl_class_datetime_method_56_elephc_extract_micros())
        .method(decl_class_datetime_method_57_elephc_strip_micros())
        .method(decl_class_datetime_method_58_elephc_extract_constructor_zone())
        .method(decl_class_datetime_method_59_elephc_extract_modify_micros())
        .method(decl_class_datetime_method_60_elephc_strip_modify_micros())
        .method(decl_class_datetime_method_61_elephc_malformed_time_message())
        .method(decl_class_datetime_method_62_elephc_sun_rs())
        .method(decl_class_datetime_method_63_elephc_sun_val())
        .method(decl_class_datetime_method_64_elephc_date_sun_info())
        .method(decl_class_datetime_method_65_elephc_date_sunfunc())
        .method(decl_class_datetime_method_66_elephc_strptime())
        .method(decl_class_datetime_method_67_elephc_timezone_name_from_abbr())
        .method(decl_class_datetime_method_68_elephc_argument_type_error())
        .method(decl_class_datetime_method_69_elephc_weak_string_argument())
        .method(decl_class_datetime_method_70_elephc_deprecated_string_constant())
        .method(decl_class_datetime_method_71_elephc_deprecated_int_constant())
        .method(decl_class_datetime_method_72_elephc_greg_to_sdn())
        .method(decl_class_datetime_method_73_elephc_sdn_to_greg())
        .method(decl_class_datetime_method_74_elephc_jul_to_sdn())
        .method(decl_class_datetime_method_75_elephc_sdn_to_jul())
        .method(decl_class_datetime_method_76_elephc_fr_to_sdn())
        .method(decl_class_datetime_method_77_elephc_sdn_to_fr())
        .method(decl_class_datetime_method_78_elephc_jew_tishri1())
        .method(decl_class_datetime_method_79_elephc_jew_molad_cycle())
        .method(decl_class_datetime_method_80_elephc_jew_find_tishri_molad())
        .method(decl_class_datetime_method_81_elephc_jew_find_start_year())
        .method(decl_class_datetime_method_82_elephc_jew_to_sdn())
        .method(decl_class_datetime_method_83_elephc_sdn_to_jew())
        .method(decl_class_datetime_method_84_elephc_jew_month_name())
        .method(decl_class_datetime_method_85_elephc_easter_calc())
        .method(decl_class_datetime_method_86_elephc_cal_to_jd())
        .method(decl_class_datetime_method_87_elephc_gregoriantojd())
        .method(decl_class_datetime_method_88_elephc_jdtogregorian())
        .method(decl_class_datetime_method_89_elephc_juliantojd())
        .method(decl_class_datetime_method_90_elephc_jdtojulian())
        .method(decl_class_datetime_method_91_elephc_frenchtojd())
        .method(decl_class_datetime_method_92_elephc_jdtofrench())
        .method(decl_class_datetime_method_93_elephc_jewishtojd())
        .method(decl_class_datetime_method_94_elephc_jdtojewish())
        .method(decl_class_datetime_method_95_elephc_easter_days())
        .method(decl_class_datetime_method_96_elephc_easter_date())
        .method(decl_class_datetime_method_97_elephc_unixtojd())
        .method(decl_class_datetime_method_98_elephc_jdtounix())
        .method(decl_class_datetime_method_99_elephc_jddayofweek())
        .method(decl_class_datetime_method_100_elephc_jdmonthname())
        .method(decl_class_datetime_method_101_elephc_cal_days_in_month())
        .method(decl_class_datetime_method_102_elephc_cal_from_jd())
        .method(decl_class_datetime_method_103_elephc_cal_info())
        .method(decl_class_datetime_method_104_elephc_is_initialized())
        .method(decl_class_datetime_method_105_elephc_assert_initialized())
        .method(decl_class_datetime_method_106_elephc_assert_comparable())
        .method(decl_class_datetime_method_107_elephc_compare())
        .build()
}
...
method("setTime")
    ...
    .body_exact(vec![
        ...
        s_assign("__d", e_cast(CastType::Int, e_call("date", vec![e_str("j"), e_this_prop("timestamp")]))),
        s_assign("__new", e_new("DateTimeImmutable", vec![])),
        s_prop_assign(e_var("__new"), "timestamp", e_call("__elephc_mktime_raw", vec![e_var("hour"), e_var("minute"), e_var("second"), e_var("__mo"), e_var("__d"), e_var("__y")])),
        s_prop_assign(e_var("__new"), "timezone_name", e_this_prop("timezone_name")),
        s_prop_assign(e_var("__new"), "__elephc_is_localtime", e_bool(true)),
        s_prop_assign(e_var("__new"), "microsecond", e_var("microsecond")),
        s_return(e_var("__new")),
    ])
}
...
method("setDate")
    ...
    .body_exact(vec![
        ...
        s_assign("__s", e_cast(CastType::Int, e_call("date", vec![e_str("s"), e_this_prop("timestamp")]))),
        s_assign("__new", e_new("DateTimeImmutable", vec![])),
        s_prop_assign(e_var("__new"), "timestamp", e_call("__elephc_mktime_raw", vec![e_var("__h"), e_var("__mi"), e_var("__s"), e_var("month"), e_var("day"), e_var("year")])),
        s_prop_assign(e_var("__new"), "timezone_name", e_this_prop("timezone_name")),
        s_prop_assign(e_var("__new"), "__elephc_is_localtime", e_bool(true)),
        s_prop_assign(e_var("__new"), "microsecond", e_this_prop("microsecond")),
        s_return(e_var("__new")),
    ])
}
...
method("add")
    ...
    .body_exact(vec![
        ...
        s_assign("__new", e_new("DateTimeImmutable", vec![])),
        s_prop_assign(e_var("__new"), "timestamp", e_call("__elephc_mktime_raw", vec![e_var("__h"), e_var("__mi"), e_var("__s"), e_var("__mo"), e_var("__d"), e_var("__y")])),
        s_prop_assign(e_var("__new"), "timezone_name", e_this_prop("timezone_name")),
        s_prop_assign(e_var("__new"), "__elephc_is_localtime", e_bool(true)),
...
method("createFromFormat")
    ...
    .body_exact(vec![
        ...
        s_assign("o", e_new("DateTimeImmutable", vec![])),
        s_assign("o", e_method_call(e_var("o"), "setTimestamp", vec![e_var("ts")])),
        s_if(
            e_not(e_var("hasU")),
            vec![
...
fn decl_class_datetimeimmutable_method_31_setisodate() -> MethodBuilder {
method("setISODate")
...
fn decl_class_datetimeimmutable_method_32_elephc_date_create() -> MethodBuilder {
method("__elephc_date_create")
    .private()
    .static_()
    .param_default("datetime", TypeExpr::Str, e_str("now"))
...
fn decl_class_datetimeimmutable_method_33_wakeup() -> MethodBuilder {
method("__wakeup")
    .attr("\\Deprecated", vec![e_named_arg("since", e_str("8.5")), e_named_arg("message", e_str("this method is obsolete, as serialization hooks are provided by __unserialize() and __serialize()"))])
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_34_serialize() -> MethodBuilder {
method("__serialize")
    .returns(t_array())
    .body_exact(vec![
        s_expr(e_method_call(e_this(), "__elephc_assert_initialized", vec![])),
...
fn decl_class_datetimeimmutable_method_35_unserialize() -> MethodBuilder {
method("__unserialize")
    .param("data", t_array())
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_36_set_state() -> MethodBuilder {
method("__set_state")
    .static_()
    .param("array", t_array())
    .returns(t_class("DateTimeImmutable"))
...
fn decl_class_datetimeimmutable_method_37_elephc_debug_dump() -> MethodBuilder {
method("__elephc_debug_dump")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_38_elephc_print_r_dump() -> MethodBuilder {
method("__elephc_print_r_dump")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_39_elephc_clone_for_period() -> MethodBuilder {
method("__elephc_clone_for_period")
    .private()
    .returns(t_class("DateTimeImmutable"))
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_40_elephc_clone_for_period_storage() -> MethodBuilder {
method("__elephc_clone_for_period_storage")
    .private()
    .returns(t_class("DateTimeImmutable"))
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_41_elephc_begin_argument_array() -> MethodBuilder {
method("__elephc_begin_argument_array")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_42_elephc_append_one_argument() -> MethodBuilder {
method("__elephc_append_one_argument")
    .private()
    .param("key", t_mixed())
    .param("value", t_mixed())
...
fn decl_class_datetimeimmutable_method_43_elephc_append_argument_chunk() -> MethodBuilder {
method("__elephc_append_argument_chunk")
    .private()
    .param("kind", TypeExpr::Int)
    .param("name", TypeExpr::Str)
...
fn decl_class_datetimeimmutable_method_44_elephc_finish_argument_array() -> MethodBuilder {
method("__elephc_finish_argument_array")
    .private()
    .returns(TypeExpr::Void)
    .body_exact(vec![
...
fn decl_class_datetimeimmutable_method_45_elephc_is_initialized() -> MethodBuilder {
method("__elephc_is_initialized")
    .private()
    .final_()
    .returns(TypeExpr::Bool)
...
fn decl_class_datetimeimmutable_method_46_elephc_assert_initialized() -> MethodBuilder {
method("__elephc_assert_initialized")
    .private()
    .final_()
    .returns(TypeExpr::Void)
...
fn decl_class_datetimeimmutable_method_47_elephc_assert_comparable() -> MethodBuilder {
method("__elephc_assert_comparable")
    .private()
    .final_()
    .returns(TypeExpr::Void)
...
fn decl_class_datetimeimmutable_method_48_elephc_compare() -> MethodBuilder {
method("__elephc_compare")
    .private()
    .final_()
    .param("other", t_class("DateTimeInterface"))
...
fn decl_class_datetimeimmutable() -> Stmt {
    class("DateTimeImmutable")
        ...
        .method(decl_class_datetimeimmutable_method_31_setisodate())
        .method(decl_class_datetimeimmutable_method_32_elephc_date_create())
        .method(decl_class_datetimeimmutable_method_33_wakeup())
        .method(decl_class_datetimeimmutable_method_34_serialize())
        .method(decl_class_datetimeimmutable_method_35_unserialize())
        .method(decl_class_datetimeimmutable_method_36_set_state())
        .method(decl_class_datetimeimmutable_method_37_elephc_debug_dump())
        .method(decl_class_datetimeimmutable_method_38_elephc_print_r_dump())
        .method(decl_class_datetimeimmutable_method_39_elephc_clone_for_period())
        .method(decl_class_datetimeimmutable_method_40_elephc_clone_for_period_storage())
        .method(decl_class_datetimeimmutable_method_41_elephc_begin_argument_array())
        .method(decl_class_datetimeimmutable_method_42_elephc_append_one_argument())
        .method(decl_class_datetimeimmutable_method_43_elephc_append_argument_chunk())
        .method(decl_class_datetimeimmutable_method_44_elephc_finish_argument_array())
        .method(decl_class_datetimeimmutable_method_45_elephc_is_initialized())
        .method(decl_class_datetimeimmutable_method_46_elephc_assert_initialized())
        .method(decl_class_datetimeimmutable_method_47_elephc_assert_comparable())
        .method(decl_class_datetimeimmutable_method_48_elephc_compare())
        .build()
}
...
fn decl_class_datetimezone_method_19_elephc_assert_initialized() -> MethodBuilder {
method("__elephc_assert_initialized")
    .private()
    .final_()
    .returns(TypeExpr::Void)
...
fn decl_class_datetimezone() -> Stmt {
    class("DateTimeZone")
        ...
        .method(decl_class_datetimezone_method_19_elephc_assert_initialized())
        .build()
}
