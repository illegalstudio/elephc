...
pub(super) fn lower_instruction(ctx: &mut FunctionContext<'_>, inst_id: InstId) -> Result<()> {
    ...
    match inst.op {
        ...
        Op::MixedCastObject => conversions::lower_mixed_cast_object(ctx, &inst),
        ...
        Op::StdClassFromHash => objects::lower_stdclass_from_hash(ctx, &inst),
        ...
        Op::HashCloneShallow => hashes::lower_hash_clone_shallow(ctx, &inst),
