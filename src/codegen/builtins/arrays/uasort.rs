...
pub fn emit(
    ...
    if is_closure {
        ...
        emitter.adrp("x19", &format!("{}", label));              // load page address of comparator function
        emitter.add_lo12("x19", "x19", &format!("{}", label));       // resolve full address of comparator function
    }
