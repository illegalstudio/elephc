...
//! - Mixed roots detach their boxed value before nested writes, preserving other copies.
...
struct PropertyContainerSplit {
    ...
    /// Mixed cloning retains the payload while leaving the old boxed owner for explicit release.
    boxed: bool,
}
