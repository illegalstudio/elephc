...
struct ReflectionAttributeLayout {
    ...
    name_lo: usize,
    name_hi: usize,
    public_name_lo: usize,
    public_name_hi: usize,
    args_lo: usize,
    args_hi: usize,
    factory_lo: usize,
    factory_hi: usize,
...
pub(in crate::codegen::lower_inst) fn emit_reflection_attribute_array(
    ctx: &mut FunctionContext<'_>,
    attr_names: &[String],
...
fn reflection_attribute_layout(ctx: &FunctionContext<'_>) -> Result<ReflectionAttributeLayout> {
    ...
    let public_name_lo = reflection_property_offset(info, "name")?;
    ...
    Ok(ReflectionAttributeLayout {
        ...
        name_hi: name_lo + 8,
        public_name_lo,
        public_name_hi: public_name_lo + 8,
        args_lo,
        args_hi: args_lo + 8,
        factory_lo,
