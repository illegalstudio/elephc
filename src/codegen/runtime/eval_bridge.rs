...
fn emit_aarch64_eval_reflection_method_names(emitter: &mut Emitter) {
...
fn emit_aarch64_eval_reflection_property_names(emitter: &mut Emitter) {
    emit_aarch64_eval_reflection_member_names(
        emitter,
...
fn emit_aarch64_eval_reflection_method_declaring_class(emitter: &mut Emitter) {
...
fn emit_aarch64_eval_reflection_property_declaring_class(emitter: &mut Emitter) {
...
fn emit_x86_64_eval_reflection_method_names(emitter: &mut Emitter) {
...
fn emit_x86_64_eval_reflection_property_names(emitter: &mut Emitter) {
    emit_x86_64_eval_reflection_member_names(
        emitter,
        "__elephc_eval_reflection_property_names",
        "_eval_reflection_property_count",
...
fn emit_x86_64_eval_reflection_member_names(
    emitter: &mut Emitter,
    symbol: &str,
    count_symbol: &str,
    table_symbol: &str,
...
fn emit_x86_64_eval_reflection_method_declaring_class(emitter: &mut Emitter) {
    label_c_global(emitter, "__elephc_eval_reflection_method_declaring_class");
    emitter.instruction("push rbp");                                            // preserve the Rust caller frame pointer
    emitter.instruction("mov rbp, rsp");                                        // establish a stable scan frame pointer
    emitter.instruction("sub rsp, 64");                                         // reserve scan state across runtime string comparisons
...
fn emit_x86_64_eval_reflection_property_declaring_class(emitter: &mut Emitter) {
    label_c_global(emitter, "__elephc_eval_reflection_property_declaring_class");
    emitter.instruction("push rbp");                                            // preserve the Rust caller frame pointer
    emitter.instruction("mov rbp, rsp");                                        // establish a stable scan frame pointer
    emitter.instruction("sub rsp, 64");                                         // reserve scan state across runtime string comparisons
...
fn emit_aarch64_eval_reflection_class_flags(emitter: &mut Emitter) {
...
fn emit_x86_64_eval_reflection_class_flags(emitter: &mut Emitter) {
    label_c_global(emitter, "__elephc_eval_reflection_class_flags");
    emitter.instruction("push rbp");                                            // preserve the Rust caller frame pointer
...
fn emit_aarch64_object_clone_shallow_wrapper(emitter: &mut Emitter) {
...
fn emit_aarch64_reject_runtime_managed_clone_classes(
    emitter: &mut Emitter,
    class_id_reg: &str,
    reject_label: &str,
) {
...
fn emit_x86_64_reject_runtime_managed_clone_classes(
    emitter: &mut Emitter,
    class_id_reg: &str,
    reject_label: &str,
) {
