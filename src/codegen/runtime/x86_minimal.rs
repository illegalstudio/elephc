...
mod tests {
    ...
    fn test_linux_x86_64_runtime_is_minimal_for_now() {
        ...
        assert!(asm.contains("__rt_fiber_entry:\n"));
        assert!(asm.contains("__rt_fiber_construct:\n"));
        assert!(asm.contains("__rt_fiber_start:\n"));
        assert!(asm.contains("__rt_fiber_resume:\n"));
        assert!(asm.contains("__rt_fiber_suspend:\n"));
        assert!(asm.contains("__rt_fiber_throw:\n"));
        assert!(asm.contains("__rt_fiber_get_current:\n"));
        assert!(asm.contains("__rt_fiber_get_return:\n"));
        assert!(asm.contains("__rt_fiber_state_eq:\n"));
