...
//! - Inline invoker emission restores the enclosing helper's ELF text section.
//! - AOT callback descriptors emitted here use `InvokerArgMode::PublicRaw`.
...
use crate::codegen::runtime_callable_invoker::{InvokerArgMode, RuntimeCallableInvoker};
    ...
    candidates
        ...
        .map(
            |(class_name, method_name, method_key, impl_class, class_id, sig)| {
                ...
                let owns_string_return = super::runtime_callable_invoker::method_returns_owned_string(
