...
//!
//! Called from:
//! - `crate::codegen::builtins::math::intdiv` and `crate::codegen::expr::binops::arithmetic`
//!   (division/modulo by zero), and any other emitter that must abort with a message.
//!
//! Key details:
