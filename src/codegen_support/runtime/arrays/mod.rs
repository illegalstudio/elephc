...
//!
//! Called from:
//! - `crate::codegen_support::runtime::emitters::emit_runtime()` during the array runtime section.
//!
//! Key details:
...
/// Emit array list-shape predicate helper (array_is_list).
...
/// Emit array multisort helper (tandem in-place sort of two parallel arrays).
...
pub use random_uniform::emit_random_uniform64;
/// Emit 64-bit uniform random integer helper over an inclusive range width.
