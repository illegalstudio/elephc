...
pub fn emit_heap_debug_report(emitter: &mut Emitter) {
    if emitter.target.arch == Arch::X86_64 {
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "r9", "_gc_frees");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "r11", "_gc_live");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_stats_prefix");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_frees_label");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_live_blocks_label");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_live_bytes_label");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_peak_label");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_newline");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_leak_prefix");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_clean_label");
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_live_blocks_short_label");
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x9", "_gc_allocs");
    emitter.instruction("ldr x9, [x9]");                                        // load the total allocation count
    crate::codegen_support::abi::emit_symbol_address(emitter, "x10", "_gc_frees");
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_stats_prefix"); // load page of the heap-debug summary prefix
    ...
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_frees_label"); // load page of the frees label
    ...
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_live_blocks_label"); // load page of the live-block label
    ...
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_live_bytes_label"); // load page of the live-bytes label
    ...
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_peak_label"); // load page of the peak-live-bytes label
    emitter.instruction("mov x2, #17");                                         // " peak_live_bytes=" length
    emitter.syscall(4);
    crate::codegen_support::abi::emit_symbol_address(emitter, "x9", "_gc_peak");
    ...
    emitter.syscall(4);
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_newline"); // load page of the newline label
    emitter.instruction("mov x2, #1");                                          // newline length
    emitter.syscall(4);

    // -- print leak-summary prefix --
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_leak_prefix"); // load page of the leak-summary prefix
    ...
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_clean_label"); // load page of the clean summary label
    ...
    emitter.label("__rt_heap_debug_report_leak_details");
    emitter.instruction("mov x0, #2");                                          // fd = stderr
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_live_blocks_short_label"); // load page of the short live-block label
