...
pub fn emit_heap_debug_validate_free_list(emitter: &mut Emitter) {
    ...
    if emitter.target.arch == Arch::X86_64 {
        ...
        crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_heap_dbg_free_list_msg");
    ...
    emitter.label("__rt_heap_debug_validate_free_list_fail");
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_heap_dbg_free_list_msg"); // load page of the free-list corruption message
