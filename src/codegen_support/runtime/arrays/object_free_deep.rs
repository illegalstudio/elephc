...
fn emit_object_free_deep_linux_x86_64(emitter: &mut Emitter) {
    ...
    emitter.instruction("cmp r10, 4");                                          // is this heap-backed payload a normal object instance (kind 4)?
    emitter.instruction("je __rt_object_free_deep_kind_ok");                    // ordinary objects take the deep-free walk
    emitter.instruction("cmp r10, 6");                                          // is this a compact Throwable payload (kind 6)?
