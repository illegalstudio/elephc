...
fn emit_extend_range_check(emitter: &mut Emitter, reg: &str, start: u32, end: u32) {
    ...
    crate::codegen_support::abi::emit_load_int_immediate(emitter, "x17", i64::from(start));
    ...
    crate::codegen_support::abi::emit_load_int_immediate(emitter, "x17", i64::from(end));
