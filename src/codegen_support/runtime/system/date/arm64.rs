...
//!
//! Called from:
//! - `crate::codegen_support::runtime::system::date::emit_date()` for AArch64 targets.
//!
//! Key details:
...
pub(super) fn emit_date_arm64(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_day_names");      // load page of day names table
    ...
    emitter.instruction("sxtw x0, w0");                                         // sign-extend
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_day_names");      // load page of day names
    emitter.instruction("mov x2, #12");                                         // entry size
    ...
    emitter.instruction("ldr w0, [x0, #16]");                                   // load tm_mon (0-based)
    emitter.instruction("sxtw x0, w0");                                         // sign-extend
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_month_names");    // load page of month names
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x3", "_php_default_tz_len");
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_php_tz_env");
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_php_tz_utc");
