...
pub(super) fn emit(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x11", "_json_int_max_str");
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x11", "_json_int_min_str");
    emitter.instruction("mov x9, #0");                                          // lex-compare cursor
