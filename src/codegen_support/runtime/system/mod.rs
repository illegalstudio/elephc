...
//!
//! Called from:
//! - `crate::codegen_support::runtime::emitters::emit_runtime()` during the system runtime section.
//!
//! Key details:
...
pub(crate) use getdate::emit_getdate;
...
pub(crate) use pcntl::{emit_pcntl_rusage_array, emit_pcntl_siginfo_array};
