...
pub fn emit_getdate(emitter: &mut Emitter) {
    ...
    match emitter.target.arch {
        Arch::AArch64 => {
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_seconds");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_minutes");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_hours");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_mday");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_wday");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_mon");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_year");
            ...
            emitter.instruction("mov x4, #0");                                  // value_hi = 0
            emitter.instruction("mov x5, #0");                                  // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_yday");
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_day_names");
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_weekday");
            ...
            emitter.instruction("mov x11, #12");                                // name-table stride is 12 bytes
            emitter.instruction("mul x10, x10, x11");                           // index * 12 → byte offset into the name table
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_month_names");
            emitter.instruction("add x1, x1, x10");                             // x1 = pointer to the name string
            emitter.instruction("ldrb w2, [x1, #10]");                          // load the name length from table offset 10
            emitter.instruction("bl __rt_str_persist");                         // copy the name to the heap → x1=ptr, x2=len
            emitter.instruction("mov x3, x1");                                  // value_lo = heap string pointer
            emitter.instruction("mov x4, x2");                                  // value_hi = string length
            emitter.instruction("mov x5, #1");                                  // value tag = string
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_gd_k_month");
        ...
        Arch::X86_64 => {
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_seconds");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_minutes");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_hours");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_mday");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_wday");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_mon");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_year");
            ...
            emitter.instruction("mov r8, 0");                                   // value_hi = 0
            emitter.instruction("mov r9, 0");                                   // value tag = int
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_yday");
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "rax", "_day_names");
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_weekday");
            ...
            emitter.instruction("imul r11, r11, 12");                           // index * 12 → byte offset into the name table
            crate::codegen_support::abi::emit_symbol_address(emitter, "rax", "_month_names");
            emitter.instruction("add rax, r11");                                // rax = pointer to the name string
            emitter.instruction("movzx edx, BYTE PTR [rax + 10]");              // load the name length from table offset 10
            emitter.instruction("call __rt_str_persist");                       // copy the name to the heap → rax=ptr, rdx=len
            emitter.instruction("mov rcx, rax");                                // value_lo = heap string pointer
            emitter.instruction("mov r8, rdx");                                 // value_hi = string length
            emitter.instruction("mov r9, 1");                                   // value tag = string
            crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_gd_k_month");
