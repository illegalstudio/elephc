//! Purpose:
//! Emits AArch64 JSON string escaping runtime helper.
...
//!
//! Key details:
//! - Escaping, UTF-8 validation, numeric-check, and flag handling are PHP-visible byte-for-byte behavior.
...
/// Caller: `crate::codegen_support::runtime::system`.
