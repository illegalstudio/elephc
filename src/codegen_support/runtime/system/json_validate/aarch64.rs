...
pub(super) fn emit(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x9", "_json_validate_ptr");
    emitter.instruction("str x1, [x9]");                                        // publish the source pointer for parse helpers
    crate::codegen_support::abi::emit_symbol_address(emitter, "x9", "_json_validate_len");
    emitter.instruction("str x2, [x9]");                                        // publish the source length for parse helpers
    crate::codegen_support::abi::emit_symbol_address(emitter, "x9", "_json_validate_idx");
    emitter.instruction("str xzr, [x9]");                                       // start parsing at the beginning of the input
    crate::codegen_support::abi::emit_symbol_address(emitter, "x9", "_json_active_depth");
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x11", "_json_validate_len");
...
fn emit_skip_ws_aarch64(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x10", "_json_validate_len");
    emitter.instruction("ldr x10, [x10]");                                      // x10 = source length
    crate::codegen_support::abi::emit_symbol_address(emitter, "x11", "_json_validate_ptr");
...
fn emit_array_parser_aarch64(emitter: &mut Emitter) {
    ...
    emitter.instruction("add x12, x12, #1");                                    // update the JSON validator cursor or counter
    emitter.instruction("str x12, [x9]");                                       // store updated JSON validator state
    crate::codegen_support::abi::emit_symbol_address(emitter, "x10", "_json_depth_limit");
    emitter.instruction("ldr x10, [x10]");                                      // load or prepare JSON validator state
    ...
    emitter.instruction("add x12, x12, #1");                                    // consume the ']'
    emitter.instruction("str x12, [x9]");                                       // store updated JSON validator state
    crate::codegen_support::abi::emit_symbol_address(emitter, "x10", "_json_active_depth");
