...
//!
//! Called from:
//! - `crate::codegen_support::runtime::system::preg_match`
//! - `crate::codegen_support::runtime::system::preg_match_all`
//! - `crate::codegen_support::runtime::system::preg_replace`
//! - `crate::codegen_support::runtime::system::preg_split`
//!
//! Key details:
...
pub(crate) fn emit_prepare_regex_locale(emitter: &mut Emitter) {
    match emitter.target.arch {
        Arch::AArch64 => {
            ...
            abi::emit_symbol_address(emitter, "x1", "_locale_utf8_name");       // load page address of the explicit UTF-8 locale name
            ...
            abi::emit_symbol_address(emitter, "x1", "_locale_env_name");        // load page address of the empty locale name
