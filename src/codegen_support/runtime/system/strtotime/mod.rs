...
//!
//! Key details:
//! - The established runtime ABI and `i64::MIN` failure sentinel stay unchanged.
...
fn emit_timelib_strtotime_x86_64(emitter: &mut Emitter) {
    ...
    emitter.instruction("sub rsp, 32");                                         // reserve aligned storage for the four incoming arguments
