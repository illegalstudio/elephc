...
pub fn emit_dirname_levels(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x1", "_dirname_levels_msg"); // load the dirname levels fatal diagnostic text
...
fn emit_dirname_levels_linux_x86_64(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "rsi", "_dirname_levels_msg"); // load the dirname levels fatal diagnostic text
