...
//!
//! Called from:
//! - `crate::codegen_support::runtime::emitters::emit_runtime()` — the runtime surface
...
pub fn emit_socket_backlog(emitter: &mut Emitter) {
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "x0", "_socket_key_str");
    emitter.instruction("mov x1, #6");                                          // strlen("socket")
    crate::codegen_support::abi::emit_symbol_address(emitter, "x2", "_socket_backlog_key_str");
