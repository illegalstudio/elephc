...
use super::{
    ...
    MB_CONVERT_CASE_BAD_ENCODING_MSG, MB_CONVERT_CASE_BAD_MODE_MSG,
...
pub(crate) fn emit_runtime_data_fixed(heap_size: usize, target: Target) -> String {
    ...
    out.push_str(&format!(
        ".globl _mb_convert_case_bad_mode_msg\n_mb_convert_case_bad_mode_msg:\n    .ascii {:?}\n",
        MB_CONVERT_CASE_BAD_MODE_MSG
    ));
    out.push_str(&format!(
        ".globl _mb_convert_case_bad_encoding_msg\n_mb_convert_case_bad_encoding_msg:\n    .ascii {:?}\n",
        MB_CONVERT_CASE_BAD_ENCODING_MSG
    ));
