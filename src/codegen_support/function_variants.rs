...
//!
//! Called from:
//! - `crate::codegen_support::generate()` after resolver-provided variant metadata
//!
//! Key details:
...
pub(crate) fn emit_function_variant_dispatcher(
    ...
    match emitter.target.arch {
        Arch::AArch64 => {
            ...
            crate::codegen_support::abi::emit_symbol_address(emitter, "x1", &message_label); // load the diagnostic string page for stderr output
