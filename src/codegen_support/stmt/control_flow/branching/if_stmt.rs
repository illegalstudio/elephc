//! Purpose:
//! Lowers if and elseif branching with shared exit labels.
//! Emits labels and condition checks while delegating nested body statements.
//!
//! Called from:
//! - `crate::codegen_support::stmt::control_flow::branching`
//!
//! Key details:
...
pub(super) fn emit_if_stmt(
    ...
    crate::codegen_support::abi::emit_branch_if_int_result_zero(emitter, &next_label);
