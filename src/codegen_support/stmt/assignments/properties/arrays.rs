...
pub(crate) use indexed::emit_property_array_assign_stmt;
        ...
        Arch::AArch64 => {
            ...
            match &val_ty {
                ...
                | PhpType::Object(_) => {
                    ...
                    crate::codegen_support::emit_release_pushed_refcounted_temp_after_array_push(emitter, &val_ty); // drop the codegen's owning reference now that the array holds its own
                }
                _ => {
