...
pub(crate) fn emit_static_property_assign_stmt(
    ...
    if let Some((current, default)) =
        crate::codegen_support::stmt::null_coalesce_static_property_target(receiver, property, value)
    {
    ...
    } else if crate::codegen_support::expr::can_coerce_result_to_type(&val_ty, &prop_ty) {
