...
use crate::codegen_support::expr::{coerce_result_to_type, emit_expr, expr_result_heap_ownership};
...
fn emit_assoc_array_push_stmt(
    ...
    if matches!(val_ty, PhpType::Mixed | PhpType::Union(_))
        ...
        && crate::codegen_support::expr::can_coerce_result_to_type(&val_ty, &assoc_value_ty)
    {
