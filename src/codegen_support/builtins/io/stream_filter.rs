...
pub fn emit_attach(
    ...
    if let ExprKind::StringLiteral(name) = &args[1].kind {
        if name == "zlib.deflate" {
            return crate::codegen_support::builtins::io::stream_filter_zlib::emit_zlib_deflate_attach(
                args, emitter, ctx, data,
            );
        }
        if name == "zlib.inflate" {
            return crate::codegen_support::builtins::io::stream_filter_inflate::emit_zlib_inflate_attach(
                args, emitter, ctx, data,
            );
        }
        if let Some(spec) = name.strip_prefix("convert.iconv.") {
            ...
            return crate::codegen_support::builtins::io::stream_filter_iconv::emit(
        ...
        if name == "bzip2.compress" {
            ...
            return crate::codegen_support::builtins::io::stream_filter_bzip2::emit_bzip2_compress_attach(
                args, emitter, ctx, data,
            );
        }
        if name == "bzip2.decompress" {
            ...
            // zlib.inflate.
            return crate::codegen_support::builtins::io::stream_filter_bzip2::emit_bzip2_decompress_attach(
                args, emitter, ctx, data,
            );
        }
    }
