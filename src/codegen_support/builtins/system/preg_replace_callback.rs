...
use crate::codegen_support::builtins::arrays::{
...
use crate::codegen_support::context::{Context, DeferredCallbackWrapper};
...
fn emit_runtime_string_preg_callback(
    ...
    let cases = crate::codegen_support::callable_dispatch::runtime_callable_cases(
        ctx,
        data,
        &[],
