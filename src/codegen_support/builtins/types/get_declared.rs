...
pub fn emit(
    ...
    let mut names: Vec<String> = match name {
        "get_declared_classes" => crate::codegen_support::declared_class_names(),
        "get_declared_interfaces" => crate::codegen_support::declared_interface_names(),
        "get_declared_traits" => crate::codegen_support::declared_trait_names(),
        _ => return None,
    };
    if names.is_empty() {
        names = match name {
