...
use crate::codegen_support::expr::{can_coerce_result_to_type, coerce_result_to_type};
...
pub(super) fn coerce_current_result_to_int_arg(
    ...
    if crate::codegen_support::stmt::helpers::should_release_owned_mixed_after_coerce(
        arg,
        source_ty,
        &PhpType::Int,
    ) {
