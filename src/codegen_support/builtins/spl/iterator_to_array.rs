...
use crate::codegen_support::expr::coerce_to_truthiness;
...
fn emit_to_array_loaded_source(
    ...
    if preserve_keys {
        ...
        match source_ty.codegen_repr() {
            ...
            PhpType::AssocArray { .. } => {
                return crate::codegen_support::builtins::arrays::array_values::emit_loaded_values(
                    source_ty,
                    emitter,
                    ctx,
                    data,
...
fn emit_to_array_loaded_iterable(
    ...
    if preserve_keys {
        ...
        let _ = crate::codegen_support::builtins::arrays::array_values::emit_loaded_values(
            &hash_ty,
            emitter,
            ctx,
            data,
