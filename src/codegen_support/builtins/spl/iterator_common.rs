...
//!
//! Called from:
//! - `crate::codegen_support::builtins::spl::iterator_count`
//! - `crate::codegen_support::builtins::spl::iterator_to_array`
//!
//! Key details:
...
use crate::codegen_support::stmt::{reload_iterator_receiver, IteratorDispatchTarget};
...
pub(super) fn emit_append_current_to_saved_array(
    ...
    crate::codegen_support::emit_box_current_value_as_mixed(emitter, &current_ty.codegen_repr());
