...
//! - `crate::codegen_support::expr::calls::descriptor_invoker_args`
//!
//! Key details:
...
fn emit_store_next_mixed_slot(
    ...
    if !matches!(ty, PhpType::Mixed | PhpType::Union(_)) {
        crate::codegen_support::emit_box_current_expr_value_as_mixed_for_container(emitter, arg, &ty);
...
pub(crate) fn emit_box_current_ref_arg_address_for_invoker(
    ...
    abi::emit_load_int_immediate(
        emitter,
        marker_tag_reg,
        crate::codegen_support::callable_invoker_args::INVOKER_ARG_REF_CELL_TAG,
    );
    abi::emit_load_int_immediate(
        emitter,
        source_tag_reg,
...
fn temporary_stack_reg(emitter: &Emitter) -> &'static str {
    match emitter.target.arch {
        crate::codegen_support::platform::Arch::AArch64 => "sp",
        crate::codegen_support::platform::Arch::X86_64 => "rsp",
    }
}
