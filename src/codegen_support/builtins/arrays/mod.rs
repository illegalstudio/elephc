//! Purpose:
//! Dispatches array, callable, and buffer-related PHP builtins to their focused codegen emitters.
...
pub(crate) mod runtime_callable_array_callback;
pub(crate) mod runtime_string_callback;
mod hash_value_type_tag;
mod rsort;
mod shuffle_fn;
mod sort;
mod store_mutating_arg;
mod uasort;
mod uksort;
mod usort;
