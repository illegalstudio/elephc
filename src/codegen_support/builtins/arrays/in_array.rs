//! Purpose:
//! Emits PHP `in_array` builtin calls for array values.
        ...
        match emitter.target.arch {
            Arch::AArch64 => {
                ...
                match &val_ty {
                    ...
                    PhpType::Mixed => {
                        let expected_tag = crate::codegen_support::runtime_value_tag(&needle_ty);
            ...
            Arch::X86_64 => {
                ...
                match &val_ty {
                    ...
                    PhpType::Mixed => {
                        let expected_tag = crate::codegen_support::runtime_value_tag(&needle_ty) as i64;
