...
//!
//! Called from:
//! - `crate::codegen_support::builtins::arrays::call_user_func`
//! - `crate::codegen_support::builtins::arrays::call_user_func_array`
//!
//! Key details:
...
use crate::codegen_support::callable_dispatch::RuntimeInstanceCallableShape;
    ...
    match resolve_callable_form(callback, ctx) {
        Some(CallableForm::InvokableObject { object, .. }) => {
            if callback_args_have_spread(callback_args) {
                ...
                .or_else(|| {
                    Some(crate::codegen_support::expr::objects::emit_method_call(
                        &object,
                        "__invoke",
                        callback_args,
                        emitter,
        ...
        Some(CallableForm::StaticMethod { receiver, method }) => {
            if callback_args_have_spread(callback_args) {
                ...
                .or_else(|| {
                    Some(crate::codegen_support::expr::objects::emit_static_method_call(
                        &receiver,
                        &method,
                        callback_args,
                        emitter,
        ...
        None => crate::codegen_support::expr::calls::emit_runtime_callable_array_call(
            callback,
            callback_args,
            emitter,
            ctx,
