...
//!
//! Called from:
//! - `crate::codegen_support::builtins::arrays::callable_forms`
//! - `crate::codegen_support::expr::calls::callable_array_runtime`
//!
//! Key details:
...
fn emit_receiver_prefixed_indexed_payload_arg_mixed(
    ...
    crate::codegen_support::callable_invoker_args::emit_clone_indexed_array_for_invoker(
        result_reg,
        source_elem_ty,
        emitter,
    );
...
fn emit_receiver_prefixed_assoc_payload_arg_mixed(emitter: &mut Emitter, ctx: &mut Context) {
    let result_reg = abi::int_result_reg(emitter);
    crate::codegen_support::callable_invoker_args::emit_clone_assoc_array_for_invoker(result_reg, emitter);
...
fn emit_receiver_prefixed_opaque_arg_mixed_after_receiver_push(
    ...
    crate::codegen_support::callable_invoker_args::emit_branch_if_mixed_arg_tag(
        tag_reg,
    ...
    crate::codegen_support::callable_invoker_args::emit_call_user_func_array_invalid_mixed_args_abort(emitter, data);
...
fn emit_new_receiver_prefixed_hash(source_stack_offset: usize, emitter: &mut Emitter) {
    ...
    abi::emit_load_int_immediate(
        emitter,
        tag_reg,
        crate::codegen_support::runtime_value_tag(&PhpType::Mixed) as i64,
    );
...
fn emit_box_receiver_prefixed_container(
    ...
    crate::codegen_support::callable_invoker_args::emit_box_invoker_arg_clone_as_mixed(
        container_reg,
        container_ty,
        emitter,
    );
