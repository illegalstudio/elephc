...
pub fn emit_builtin_call(
    ...
    let args = if let Some(sig) = crate::types::builtin_call_sig(name) {
        let regular_param_count =
            crate::codegen_support::expr::calls::args::regular_param_count(Some(&sig), args.len());
        let normalized = if crate::codegen_support::expr::calls::args::has_named_args(args) {
            ...
            crate::codegen_support::expr::calls::args::normalize_builtin_call_args_with_checks(&sig, args)
        };
