...
//!
//! Called from:
//! - `crate::codegen_support::program_usage::required_classes`
//!
//! Key details:
...
pub(in crate::codegen_support) fn collect_required_class_names(program: &Program) -> HashSet<String> {
...
pub(in crate::codegen_support) fn collect_required_class_names_in_stmts(
    stmts: &[Stmt],
