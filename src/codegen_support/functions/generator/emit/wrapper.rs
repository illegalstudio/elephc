...
//!
//! Called from:
//!  - `crate::codegen_support::functions::generator::emit_generator_function()` via
...
pub(in crate::codegen_support::functions::generator) fn emit_wrapper(
    emitter: &mut Emitter,
    label: &str,
    resume_label: &str,
    class_id: u64,
...
fn emit_wrapper_x86_64(
    ...
    crate::codegen_support::abi::emit_symbol_address(emitter, "r10", resume_label);
