...
//!
//! Called from:
//!  - `crate::codegen_support::functions::generator::mod::emit_generator_function()`.
//!
//! Key details:
...
//!    `crate::codegen_support::runtime::generators::frame`; both wrapper and resume
//!    paths must agree with that contract.

use crate::codegen_support::runtime::generators::frame as gen_frame;
...
pub(in crate::codegen_support::functions::generator) use dispatcher::emit_resume;
pub(in crate::codegen_support::functions::generator) use wrapper::emit_wrapper;
