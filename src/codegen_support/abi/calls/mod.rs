...
//!
//! Called from:
//! - `crate::codegen_support::abi` and call expression emitters
//!
//! Key details:
...
pub use outgoing::{
    ...
    materialize_outgoing_args, materialize_outgoing_c_abi_args, outgoing_call_stack_pad_bytes,
};
#[cfg(test)]
pub use outgoing::compact_windows_c_abi_stack_args;
pub use stack::{
    ...
    emit_release_temporary_stack, emit_reserve_temporary_stack, emit_store_to_sp,
