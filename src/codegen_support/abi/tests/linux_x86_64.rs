...
fn test_build_outgoing_arg_assignments_for_linux_x86_64_respects_sysv_limits() {
    ...
    assert_eq!(assignments[6].start_reg, crate::codegen_support::abi::registers::STACK_ARG_SENTINEL);
    assert_eq!(assignments[7].start_reg, crate::codegen_support::abi::registers::STACK_ARG_SENTINEL);
    assert!(assignments[8].is_float);
    assert_eq!(assignments[15].start_reg, 7);
    assert_eq!(assignments[16].start_reg, crate::codegen_support::abi::registers::STACK_ARG_SENTINEL);
}
...
fn test_emit_extern_symbol_address_uses_gotpcrel_on_linux_x86_64() {
    let mut emitter = test_emitter_x86();
    crate::codegen_support::abi::symbols::emit_extern_symbol_address(&mut emitter, "r11", "demo_extern");
...
fn test_pic_load_symbol_to_int_reg_self_scratches_on_linux_x86_64() {
    ...
    crate::codegen_support::abi::emit_load_symbol_to_reg(&mut emitter, "r10", "_concat_off", 0);
...
fn test_pic_load_symbol_to_float_reg_protects_r11_on_linux_x86_64() {
    let mut emitter = test_emitter_x86_pic();
    crate::codegen_support::abi::emit_load_symbol_to_reg(&mut emitter, "xmm0", "_float_slot", 8);
...
fn test_pic_store_reg_to_symbol_protects_scratch_on_linux_x86_64() {
    let mut emitter = test_emitter_x86_pic();
    crate::codegen_support::abi::emit_store_reg_to_symbol(&mut emitter, "rax", "_concat_off", 0);
    crate::codegen_support::abi::emit_store_reg_to_symbol(&mut emitter, "r11", "_concat_off", 0);
...
fn test_cmp_reg_to_symbol_non_pic_and_pic_on_linux_x86_64() {
    let mut emitter = test_emitter_x86();
    crate::codegen_support::abi::emit_cmp_reg_to_symbol(&mut emitter, "rax", "_class_destruct_count");
    assert_eq!(
        emitter.output(),
...
fn test_dec_symbol_non_pic_and_pic_on_linux_x86_64() {
    let mut emitter = test_emitter_x86();
    crate::codegen_support::abi::emit_dec_symbol(&mut emitter, "_http_active_max_redirects");
    assert_eq!(
        emitter.output(),
