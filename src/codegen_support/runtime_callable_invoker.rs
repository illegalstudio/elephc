...
//! - `crate::codegen_support::functions` deferred-emission loops.
//!
//! Key details:
...
use crate::codegen_support::context::{Context, DeferredRuntimeCallableInvoker};
...
pub(crate) fn emit_runtime_callable_invoker(
    ...
    crate::codegen_support::emit_box_current_value_as_mixed(emitter, &ret_ty.codegen_repr());
