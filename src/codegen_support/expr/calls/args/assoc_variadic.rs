...
//! - `crate::codegen_support::expr::calls::args::spread`
//!
//! Key details:
...
use crate::codegen_support::{abi, context::Context};
...
pub(crate) fn emit_loaded_assoc_variadic_array_arg(
    ...
    abi::emit_load_int_immediate(
        emitter,
        tag_reg,
        crate::codegen_support::runtime_value_tag(&variadic_elem_ty.codegen_repr()) as i64,
    );
