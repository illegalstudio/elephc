...
use crate::codegen_support::{abi, context::Context, data_section::DataSection, functions};
...
pub(crate) fn emit_empty_variadic_array_arg(context_label: &str, emitter: &mut Emitter) -> PhpType {
    ...
    let (capacity_reg, elem_size_reg) = match emitter.target.arch {
        crate::codegen_support::platform::Arch::AArch64 => ("x0", "x1"),
        crate::codegen_support::platform::Arch::X86_64 => ("rdi", "rsi"),
    };
