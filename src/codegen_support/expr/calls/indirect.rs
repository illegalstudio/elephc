...
use crate::codegen_support::builtins::arrays::call_user_func_array::{self, LoadedArraySource};
...
pub(super) fn emit_loaded_expr_call(
    ...
    if let Some(class_name) =
        crate::codegen_support::functions::singular_object_class(loaded_callee_ty).map(str::to_string)
    {
        if ctx
            .classes
            .get(&class_name)
            .is_some_and(|class_info| class_info.methods.contains_key("__invoke"))
        {
            ...
            return crate::codegen_support::expr::objects::emit_method_call_with_saved_receiver_below_args(
                &class_name,
                "__invoke",
    ...
    let captures = crate::codegen_support::callables::callable_captures(callee, ctx);
    crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // save the already-evaluated callable below later arguments
    ...
    let call_reg = crate::codegen_support::abi::nested_call_reg(emitter);
    let arg_temp_bytes = args::pushed_temp_bytes(&arg_types) + emitted_args.source_temp_bytes;
    crate::codegen_support::abi::emit_load_temporary_stack_slot(emitter, call_reg, arg_temp_bytes);
    ...
    let ret_ty = callee_sig
        ...
        .unwrap_or_else(|| match &callee.kind {
            ExprKind::Closure {
                ...
                ..
            } => crate::codegen_support::functions::codegen_static_type(type_ann, ctx),
    ...
    if save_concat_before_args {
        crate::codegen_support::abi::emit_call_reg(emitter, call_reg);
        ...
        crate::codegen_support::abi::emit_release_temporary_stack(emitter, 16);
...
fn emit_descriptor_invoker_expr_call(
    ...
    let ownership = crate::codegen_support::expr::expr_result_heap_ownership(callee);
    ...
    crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // preserve the callable descriptor while building direct-call arguments
    ...
    crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // preserve the owned descriptor-invoker argument array

    let call_reg = crate::codegen_support::abi::nested_call_reg(emitter);
    crate::codegen_support::abi::emit_load_temporary_stack_slot(emitter, call_reg, 16);
...
fn emit_loaded_invokable_object_descriptor_call(
    ...
    let case = crate::codegen_support::callable_dispatch::runtime_instance_method_case(
        ...
        class_name,
        "__invoke",
        crate::codegen_support::callable_dispatch::RuntimeInstanceCallableShape::ObjectInvoke,
    )?;
    if !case.has_invoker {
        return None;
    }
    ...
    crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // preserve the loaded invokable object below later descriptor arguments
    ...
    let call_reg = crate::codegen_support::abi::nested_call_reg(emitter);
    crate::codegen_support::abi::emit_symbol_address(emitter, call_reg, &case.descriptor_label);
    call_user_func_array::emit_call_descriptor_array_invoker(
...
fn release_preserved_loaded_invokable_object_after_mixed_result(
    ...
    if crate::codegen_support::expr::expr_result_heap_ownership(callee) == HeapOwnership::Owned {
        crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // preserve the boxed call result while releasing the loaded invokable object
        crate::codegen_support::abi::emit_load_temporary_stack_slot(
            emitter,
            crate::codegen_support::abi::int_result_reg(emitter),
            16,
        );
        crate::codegen_support::abi::emit_decref_if_refcounted(emitter, loaded_callee_ty);
        crate::codegen_support::abi::emit_pop_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // restore the boxed call result after object cleanup
    }
    crate::codegen_support::abi::emit_release_temporary_stack(emitter, 16);             // discard the saved loaded invokable object slot
}
...
fn release_preserved_expr_call_arg_array_after_mixed_result(
    ...
    crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // preserve the boxed call result while releasing the argument array
    crate::codegen_support::abi::emit_load_temporary_stack_slot(
        emitter,
        crate::codegen_support::abi::int_result_reg(emitter),
        16,
    );
    crate::codegen_support::abi::emit_decref_if_refcounted(emitter, arr_ty);
    crate::codegen_support::abi::emit_pop_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // restore the boxed call result after argument-array cleanup
    crate::codegen_support::abi::emit_release_temporary_stack(emitter, 16);             // discard the preserved argument-array slot
}
...
fn release_preserved_expr_call_descriptor_after_mixed_result(emitter: &mut Emitter) {
    crate::codegen_support::abi::emit_push_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // preserve the boxed call result while releasing the callable descriptor
    crate::codegen_support::abi::emit_load_temporary_stack_slot(
        emitter,
        crate::codegen_support::abi::int_result_reg(emitter),
        16,
    ...
    crate::codegen_support::abi::emit_pop_reg(emitter, crate::codegen_support::abi::int_result_reg(emitter)); // restore the boxed call result after descriptor cleanup
    crate::codegen_support::abi::emit_release_temporary_stack(emitter, 16);             // discard the preserved callable descriptor slot
}
...
fn callee_sig_for_expr(
    ...
    if let Some(sig) = crate::codegen_support::callables::callable_sig(callee, ctx) {
        return Some(sig);
    }
    match &callee.kind {
