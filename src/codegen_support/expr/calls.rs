...
pub(super) fn emit_loaded_runtime_string_call(
    ...
    crate::codegen_support::abi::emit_push_reg_pair(emitter, ptr_reg, len_reg);         // preserve the runtime string callback name while building descriptor arguments
    ...
    let ret_ty =
        crate::codegen_support::builtins::arrays::call_user_func_array::emit_loaded_array_string_callback_call(
            crate::codegen_support::builtins::arrays::call_user_func_array::LoadedArraySource::Result,
            &arr_ty,
            0,
            8,
            call_reg,
    ...
    crate::codegen_support::abi::emit_release_temporary_stack(emitter, 16);             // discard the preserved runtime string callback name
    ret_ty
}
...
fn emit_instance_callable_array_variable_call(
    ...
    let class_name = crate::codegen_support::functions::singular_object_class(&receiver_ty)?;
    let case = crate::codegen_support::callable_dispatch::runtime_instance_method_case(
        ctx,
        data,
        class_name,
...
fn emit_static_callable_array_descriptor_call(
    ...
    let case = crate::codegen_support::callable_dispatch::runtime_static_method_case(
        ctx,
        data,
        class_name.as_str(),
        method,
...
fn emit_callable_array_descriptor_case_call(
    ...
    let call_reg = crate::codegen_support::abi::nested_call_reg(emitter);
    crate::codegen_support::abi::emit_symbol_address(emitter, call_reg, descriptor_label);
