...
pub(in crate::codegen_support::expr::objects) fn emit_immediate_class_id(emitter: &mut Emitter, class_id: u64) {
...
pub(in crate::codegen_support::expr::objects) fn emit_forwarded_called_class_id(emitter: &mut Emitter, ctx: &Context) -> bool {
...
pub(in crate::codegen_support::expr::objects) fn emit_static_method_call(
