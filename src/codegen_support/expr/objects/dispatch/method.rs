...
pub(in crate::codegen_support::expr::objects) fn emit_method_call_with_pushed_args(
    class_name: &str,
    method: &str,
    arg_types: &[PhpType],
...
pub(in crate::codegen_support::expr::objects) fn emit_method_call_with_saved_receiver_below_args(
    class_name: &str,
    method: &str,
    arg_types: &[PhpType],
    source_temp_bytes: usize,
...
pub(in crate::codegen_support::expr::objects) fn emit_pushed_method_args(
    args: &[Expr],
...
pub(in crate::codegen_support::expr::objects) fn emit_method_call(
    object: &Expr,
    method: &str,
    args: &[Expr],
    emitter: &mut Emitter,
    ...
    let fiber_start_sig = if class_name == "Fiber" && dispatch_method == "start" {
        crate::codegen_support::fiber_sigs::fiber_start_sig_for_expr(object, ctx)
