...
pub(crate) const ASSERT_METRICS: &[(&str, &str)] = &[
    ...
    ("streams", "stream operations it performs itself (fopen/fread/fwrite/…)"),
...
pub(crate) fn assert_metric_value(
    ...
    match metric {
        ...
        "streams" => Some(node.stream_exclusive as f64),
...
pub(crate) fn assert_run_total(metric: &str, graph: &crate::call_graph::CallGraph, root_ns: u64) -> Option<f64> {
    ...
    match metric {
        ...
        "streams" => Some(sum_excl(|n| n.stream_exclusive as f64)),
