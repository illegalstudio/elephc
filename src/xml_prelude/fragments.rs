...
function __elephc_xml_set_element_handler(mixed $parser, mixed $start_handler, mixed $end_handler): bool {
    ...
    throw new TypeError("xml_set_element_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_character_data_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_character_data_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_processing_instruction_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_processing_instruction_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_default_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_default_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_unparsed_entity_decl_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_unparsed_entity_decl_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_notation_decl_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_notation_decl_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_external_entity_ref_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_external_entity_ref_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_start_namespace_decl_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_start_namespace_decl_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
...
function __elephc_xml_set_end_namespace_decl_handler(mixed $parser, mixed $handler): bool {
    ...
    throw new TypeError("xml_set_end_namespace_decl_handler(): Argument #1 ($parser) must be of type XMLParser, " . get_debug_type($parser) . " given");
}
