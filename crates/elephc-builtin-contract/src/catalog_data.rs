...
writes: None,
    ...
    BuiltinContract {
        id: BuiltinId::from_canonical_name("__elephc_deprecated"),
        name: "__elephc_deprecated",
        area: Area::System,
        kind: BuiltinKind::Function,
        params: &[
            ParamSpec {
...
writes: None,
        ...
        returns: TypeSpec::Void,
        by_ref_return: false,
        summary: "Raises one php `Deprecated:` diagnostic from an injected prelude body.",
        examples: &[
        ],
        php_manual: None,
        deprecation: None,
...
writes: None,
    ...
    BuiltinContract {
        id: BuiltinId::from_canonical_name("similar_text"),
        name: "similar_text",
        area: Area::String,
        kind: BuiltinKind::Function,
        params: &[
            ...
            // php writes the percentage THROUGH the reference and answers the count, so this is
            // an out-parameter and not a third input.
            ParamSpec {
                name: "percent",
                ty: TypeSpec::Mixed,
                default: Some(DefaultSpec::Null),
                by_ref: true,
                writes: Some(TypeSpec::Float),
            },
        ],
        variadic: None,
        variadic_writes: None,
        ...
        php_manual: Some("https://www.php.net/manual/en/function.similar-text.php"),
        deprecation: None,
        extension: false,
        internal: false,
        requirements: &[],
...
writes: None,
            ...
            // php's fourth argument is a by-reference COUNT of the replacements that fired.
            // It was declared by VALUE and capped out by `max_args: 3`, so the idiomatic
            // `str_replace($a, $b, $s, $n)` did not compile at all.
            ParamSpec {
                name: "count",
                ty: TypeSpec::Mixed,
                default: Some(DefaultSpec::Null),
