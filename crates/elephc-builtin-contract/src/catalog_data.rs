...
pub(crate) static CONTRACTS: &[BuiltinContract] = &[
    ...
    BuiltinContract {
        id: BuiltinId::from_canonical_name("__elephc_diag_warning"),
    ...
    BuiltinContract {
        id: BuiltinId::from_canonical_name("__elephc_object_clone_internal"),
        name: "__elephc_object_clone_internal",
        area: Area::Callables,
        module: PhpModule::Elephc,
        since: None,
        kind: BuiltinKind::Function,
        ...
        returns: TypeSpec::Mixed,
        by_ref_return: false,
        summary: "Internal: clones compiler-private object storage without a PHP handle.",
        examples: &[
        ],
        php_manual: None,
        deprecation: None,
    ...
    BuiltinContract {
        id: BuiltinId::from_canonical_name("__elephc_var_dump_indent"),
        name: "__elephc_var_dump_indent",
        area: Area::Io,
        module: PhpModule::Elephc,
        since: None,
        kind: BuiltinKind::Function,
        ...
        returns: TypeSpec::Int,
        by_ref_return: false,
        summary: "Adjusts and reads the recursive var_dump indentation depth.",
        examples: &[],
        php_manual: None,
        deprecation: None,
        extension: false,
    ...
    BuiltinContract {
        ...
        max_args: None,
        arity_error: None,
        returns: TypeSpec::Union(&[TypeSpec::Int, TypeSpec::False]),
        by_ref_return: false,
