...
pub(crate) static CONTRACTS: &[BuiltinContract] = &[
    ...
    BuiltinContract {
        id: BuiltinId::from_canonical_name("strip_tags"),
        name: "strip_tags",
        area: Area::String,
        kind: BuiltinKind::Function,
        params: &[
        ...
        returns: TypeSpec::Str,
        by_ref_return: false,
        summary: "Strips HTML and PHP tags from a string. Optional allowed_tags is a string like \"<p><a>\" or an array of tag names.",
        examples: &[
            "echo strip_tags(\"<p>Hello <b>World</b></p>\");",
            "echo strip_tags(\"<p>Hello <b>World</b></p>\", \"<p>\");",
            "echo strip_tags(\"<p>Hello <b>World</b></p>\", [\"p\"]);",
        ],
        php_manual: Some("https://www.php.net/manual/en/function.strip-tags.php"),
        deprecation: None,
        extension: false,
        internal: false,
        requirements: &[],
