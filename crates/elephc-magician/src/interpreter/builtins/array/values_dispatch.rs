...
pub(in crate::interpreter) fn eval_array_declared_values_result(
    ...
    match name {
        ...
        "end" => super::end::eval_end_declared_values_result(evaluated_args, context, values),
        "next" => super::next::eval_next_declared_values_result(evaluated_args, context, values),
        "prev" => super::prev::eval_prev_declared_values_result(evaluated_args, context, values),
        "reset" => super::reset::eval_reset_declared_values_result(evaluated_args, context, values),
