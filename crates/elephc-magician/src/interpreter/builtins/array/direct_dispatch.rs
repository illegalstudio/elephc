...
pub(in crate::interpreter) fn eval_builtin_array_declared_call(
    ...
    match name {
        ...
        "array_count_values" => super::array_count_values::eval_array_count_values_declared_call(args, context, scope, values),
        ...
        "count" | "sizeof" => super::count::eval_count_declared_call(args, context, scope, values),
