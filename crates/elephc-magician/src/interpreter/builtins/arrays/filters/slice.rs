//! Purpose:
//! Implements PHP `array_slice()` eval support and shared slice-bound helpers.
//!
//! Called from:
//! - `crate::interpreter::builtins::arrays::filters` and splice helpers.
//!
//! Key details:
//! - Negative offsets and lengths are normalized to bounded source positions.
