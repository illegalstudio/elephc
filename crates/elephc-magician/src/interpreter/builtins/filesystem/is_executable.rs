...
pub(in crate::interpreter) fn eval_is_executable_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("is_executable", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_is_executable_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("is_executable", evaluated_args, context, values)
}
