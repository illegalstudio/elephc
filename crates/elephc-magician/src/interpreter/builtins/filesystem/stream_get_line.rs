...
pub(in crate::interpreter) fn eval_stream_get_line_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("stream_get_line", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_stream_get_line_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("stream_get_line", evaluated_args, context, values)
}
