...
pub(in crate::interpreter) fn eval_vfprintf_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("vfprintf", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_vfprintf_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("vfprintf", evaluated_args, context, values)
}
