...
pub(in crate::interpreter) fn eval_filegroup_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("filegroup", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_filegroup_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("filegroup", evaluated_args, context, values)
}
