...
pub(in crate::interpreter) fn eval_fileperms_declared_call(
    ...
    super::stat::eval_builtin_file_stat_scalar("fileperms", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_fileperms_declared_values_result(
    ...
    match evaluated_args {
        [filename] => super::stat::eval_file_stat_scalar_result("fileperms", *filename, context, values),
