...
pub(in crate::interpreter) fn eval_disk_free_space_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("disk_free_space", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_disk_free_space_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("disk_free_space", evaluated_args, context, values)
}
