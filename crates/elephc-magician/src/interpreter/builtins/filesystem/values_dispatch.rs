...
pub(in crate::interpreter) fn eval_filesystem_values_result(
    ...
    match name {
        ...
        "fputs" => super::fputs::eval_fputs_declared_values_result(evaluated_args, context, values),
        ...
        "stream_context_set_options" => super::stream_context_set_options::eval_stream_context_set_options_declared_values_result(evaluated_args, context, values),
        ...
        "socket_set_timeout" => super::socket_set_timeout::eval_socket_set_timeout_declared_values_result(evaluated_args, context, values),
        "stream_register_wrapper" => super::stream_register_wrapper::eval_stream_register_wrapper_declared_values_result(evaluated_args, context, values),
