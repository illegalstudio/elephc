...
pub(in crate::interpreter) fn eval_link_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("link", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_link_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("link", evaluated_args, context, values)
}
