...
pub(in crate::interpreter) fn eval_fileinode_declared_call(
    ...
    super::stat::eval_builtin_file_stat_scalar("fileinode", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_fileinode_declared_values_result(
    ...
    match evaluated_args {
        [filename] => super::stat::eval_file_stat_scalar_result("fileinode", *filename, context, values),
