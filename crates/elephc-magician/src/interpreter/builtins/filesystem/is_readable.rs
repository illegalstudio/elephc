...
pub(in crate::interpreter) fn eval_is_readable_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("is_readable", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_is_readable_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("is_readable", evaluated_args, context, values)
}
