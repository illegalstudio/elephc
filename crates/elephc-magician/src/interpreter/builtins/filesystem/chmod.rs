...
pub(in crate::interpreter) fn eval_chmod_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("chmod", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_chmod_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("chmod", evaluated_args, context, values)
}
