...
pub(in crate::interpreter) fn eval_file_get_contents_declared_call(
    ...
    super::direct_dispatch::eval_builtin_filesystem_call_impl("file_get_contents", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_file_get_contents_declared_values_result(
    ...
    super::values_dispatch::eval_filesystem_values_result_impl("file_get_contents", evaluated_args, context, values)
}
