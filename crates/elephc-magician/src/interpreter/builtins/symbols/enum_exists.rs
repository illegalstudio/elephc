...
pub(in crate::interpreter) fn eval_enum_exists_declared_call(
    ...
    super::class_names::eval_builtin_class_like_exists("enum_exists", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_enum_exists_declared_values_result(
    ...
    super::class_names::eval_class_like_exists_result("enum_exists", evaluated_args, context, values)
}
