...
pub(in crate::interpreter) fn eval_get_declared_traits_declared_call(
    ...
    super::dispatch::eval_builtin_symbols_call_impl("get_declared_traits", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_get_declared_traits_declared_values_result(
    ...
    super::dispatch::eval_symbols_values_result_impl("get_declared_traits", evaluated_args, context, values)
}
