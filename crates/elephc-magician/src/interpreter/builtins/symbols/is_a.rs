...
pub(in crate::interpreter) fn eval_is_a_declared_call(
    ...
    super::class_relations::eval_builtin_is_a_relation("is_a", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_is_a_declared_values_result(
    ...
    super::class_relations::eval_is_a_relation_result("is_a", evaluated_args, context, values)
}
