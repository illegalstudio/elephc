...
pub(in crate::interpreter) fn eval_class_attribute_args_declared_call(
    ...
    super::super::eval_builtin_class_attribute_metadata("class_attribute_args", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_class_attribute_args_declared_values_result(
    ...
    super::super::eval_class_attribute_metadata_result("class_attribute_args", evaluated_args, context, values)
}
