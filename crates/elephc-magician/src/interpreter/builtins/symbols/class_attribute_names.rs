...
pub(in crate::interpreter) fn eval_class_attribute_names_declared_call(
    ...
    super::dispatch::eval_builtin_symbols_call_impl("class_attribute_names", args, context, scope, values)
}
...
pub(in crate::interpreter) fn eval_class_attribute_names_declared_values_result(
    ...
    super::dispatch::eval_symbols_values_result_impl("class_attribute_names", evaluated_args, context, values)
}
