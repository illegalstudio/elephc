...
pub(in crate::interpreter) fn eval_reflection_method_invoke_result(
    ...
    if is_invoke_args {
        ...
        return with_array_call_arguments(array, context, values, |arguments, context, values| {
...
pub(in crate::interpreter) fn eval_reflection_function_invoke_result(
    ...
    let function_args = evaluated_args.into_iter().map(eval_reflection_method_forwarded_value_arg).collect();
