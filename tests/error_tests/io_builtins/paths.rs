...
/// Verifies the error diagnostic for ftell wrong args.
#[test]
fn test_error_ftell_wrong_args() {
    expect_error("<?php ftell();", "ftell() takes exactly 1 argument");
}

/// Verifies the error diagnostic for fseek wrong args.
#[test]
...
/// Verifies the error diagnostic for basename wrong args.
#[test]
fn test_error_basename_wrong_args() {
    expect_error("<?php basename();", "basename() takes 1 or 2 arguments");
}

/// Verifies the error diagnostic for dirname rejects static levels below one.
#[test]
...
/// Verifies the error diagnostic for fnmatch wrong args.
#[test]
fn test_error_fnmatch_wrong_args() {
    expect_error("<?php fnmatch(\"*.txt\");", "fnmatch() takes 2 or 3 arguments");
}

/// Verifies the error diagnostic for fnmatch rejects non int flags.
#[test]
...
/// Verifies the error diagnostic for pathinfo rejects non int flags.
#[test]
...
/// Verifies the error diagnostic for realpath wrong args.
#[test]
