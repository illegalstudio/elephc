...
/// The exact diagnostic line elephc emits for one NAN-to-string coercion.
///
...
/// Returns `NAN_WARNING` repeated `count` times, i.e. every warning a program that coerced
/// a NAN to a string exactly `count` times prints.
