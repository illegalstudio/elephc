...
#[test]
fn bounded_user_symbol_assembly_skips_inline_registration_globals() {
    let assembly = r#".globl _method_Example_probe
_method_Example_probe:
    call source_pin
...
"#;
    ...
    let selected = bounded_user_symbol_assembly(assembly, "_method_Example_probe");
    ...
    assert!(selected.contains("call instanceof_query"), "{selected}");
