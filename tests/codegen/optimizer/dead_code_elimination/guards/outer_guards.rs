...
/// Verifies dead code elimination prunes nested if region from outer strict bool guard.
#[test]
...
/// Verifies dead code elimination invalidates outer strict bool guard after local write.
#[test]
...
/// Verifies dead code elimination prunes nested if region from outer and guard.
#[test]
...
/// Verifies dead code elimination prunes nested if region from outer negated and guard.
#[test]
