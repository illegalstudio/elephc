...
///
/// The legacy AST backend was removed in v0.26.0; fixtures always use EIR now.
/// This helper is kept so any test code that gated behavior on the backend
/// continues to compile and behaves correctly.
...
pub(crate) fn ir_opt_enabled_for_codegen_fixture() -> bool {
