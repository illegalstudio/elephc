...
| [`getenv()`](./builtins/filesystem/getenv.md) | `(string $name): string|false` | `string|false` | ✓ | ✓ |
...
| [`preg_match_all()`](./builtins/regex/preg_match_all.md) | `(string $pattern, string $subject, mixed $matches = [], int $flags = 0): int` | `int` | ✓ | ✓ |
