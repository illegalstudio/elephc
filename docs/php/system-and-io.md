...
Eval path component calls include `basename()` and `dirname()` with suffix trimming, repeated parent traversal, named arguments, callable dispatch, and `function_exists()` probes.
