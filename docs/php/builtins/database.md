...
| [`mysqli_error_list()`](./database/mysqli_error_list.md) | `(mixed $mysql): array` | `array` | ✓ | — |
...
| [`mysqli_execute_query()`](./database/mysqli_execute_query.md) | `(mixed $mysql, string $query, ?array $params = null): mixed` | `mixed` | ✓ | — |
| [`mysqli_fetch_all()`](./database/mysqli_fetch_all.md) | `(mixed $result, int $mode = 2): array` | `array` | ✓ | — |
| [`mysqli_fetch_array()`](./database/mysqli_fetch_array.md) | `(mixed $result, int $mode = 3): ?array` | `?array` | ✓ | — |
| [`mysqli_fetch_assoc()`](./database/mysqli_fetch_assoc.md) | `(mixed $result): ?array` | `?array` | ✓ | — |
...
| [`mysqli_fetch_fields()`](./database/mysqli_fetch_fields.md) | `(mixed $result): array` | `array` | ✓ | — |
| [`mysqli_fetch_lengths()`](./database/mysqli_fetch_lengths.md) | `(mixed $result): ?array` | `?array` | ✓ | — |
| [`mysqli_fetch_object()`](./database/mysqli_fetch_object.md) | `(mixed $result, string $class = 'stdClass', array $constructor_args = []): mixed` | `mixed` | ✓ | — |
| [`mysqli_fetch_row()`](./database/mysqli_fetch_row.md) | `(mixed $result): ?array` | `?array` | ✓ | — |
...
| [`mysqli_stmt_error_list()`](./database/mysqli_stmt_error_list.md) | `(mixed $statement): array` | `array` | ✓ | — |
| [`mysqli_stmt_execute()`](./database/mysqli_stmt_execute.md) | `(mixed $statement, ?array $params = null): bool` | `bool` | ✓ | — |
...
| [`pdo_drivers()`](./database/pdo_drivers.md) | `(): array` | `array` | ✓ | — |
