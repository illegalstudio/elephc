...
| [`gmmktime()`](./date/gmmktime.md) | `(int $hour, int $minute = null, int $second = null, int $month = null, int $day = null, int $year = null): int` | `int` | ✓ | ✓ |
...
| [`mktime()`](./date/mktime.md) | `(int $hour, int $minute = null, int $second = null, int $month = null, int $day = null, int $year = null): int` | `int` | ✓ | ✓ |
