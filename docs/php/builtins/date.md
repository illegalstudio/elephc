...
| [`cal_from_jd()`](./date/cal_from_jd.md) | `(int $julian_day, int $calendar): mixed` | `mixed` | ✓ | ✓ |
| [`cal_info()`](./date/cal_info.md) | `(int $calendar = -1): mixed` | `mixed` | ✓ | ✓ |
...
| [`date_parse()`](./date/date_parse.md) | `(string $datetime): mixed` | `mixed` | ✓ | ✓ |
| [`date_parse_from_format()`](./date/date_parse_from_format.md) | `(string $format, string $datetime): mixed` | `mixed` | ✓ | ✓ |
| [`date_sub()`](./date/date_sub.md) | `(mixed $object, mixed $interval): mixed` | `mixed` | ✓ | ✓ |
| [`date_sun_info()`](./date/date_sun_info.md) | `(int $timestamp, float $latitude, float $longitude): mixed` | `mixed` | ✓ | ✓ |
...
| [`timezone_identifiers_list()`](./date/timezone_identifiers_list.md) | `(int $timezoneGroup = DateTimeZone::ALL, string $countryCode = null): mixed` | `mixed` | ✓ | ✓ |
