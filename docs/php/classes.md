...
| `ReflectionParameter::getType()` | `?ReflectionNamedType\|ReflectionUnionType` | The declared type, or `null` when untyped |
| `ReflectionParameter::isDefaultValueAvailable()` | `bool` | True when a supported default value is available |
| `ReflectionParameter::getDefaultValue()` | `mixed` | The scalar or null default value, or throws when unavailable |
