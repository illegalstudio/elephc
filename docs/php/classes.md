...
| `ReflectionClass::implementsInterface()` | `new ReflectionClass($class_name)` | Return whether the reflected class-like symbol implements, extends, or is the requested interface; interface lookup is case-insensitive |
