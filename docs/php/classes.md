...
| `ReflectionProperty::getValue()` | Inline `new ReflectionProperty($class_name, $property_name)` with an explicit object argument | Read supported public instance property storage |
