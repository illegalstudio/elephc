...
| `ReflectionProperty::getValue()` | Inline `new ReflectionProperty($class_name, $property_name)` or `ReflectionClass::getProperty()` with an explicit object argument | Read supported public instance property storage |
