...
- `ReflectionFunction` supports `getName()`, `getAttributes()`, `getParameters()`, `getNumberOfParameters()`, and `getNumberOfRequiredParameters()` for statically known user functions.
