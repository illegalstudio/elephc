...
Reserved PHP class-like declaration names are rejected, while semi-reserved
names that PHP allows, such as `enum`, `from`, and `resource`, remain valid.
