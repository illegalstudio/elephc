...
fallback from eval remains fixed-arity and positional, so named method arguments
are supported for eval-declared methods but not for every generated native method
bridge.
