...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3371](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3371) (`lower_popen`)
