...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/math/binary.rs`:23](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/math/binary.rs#L23) (`lower_intdiv`)
