...
- Emits the typed EIR target `runtime.bcmod` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.bcmod`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/math/bcmod.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/math/bcmod.rs) (`eval_builtin!`)
...
- [User reference for `bcmod()`](../../../php/builtins/math/bcmod.md)
