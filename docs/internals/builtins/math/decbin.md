...
- Emits the typed EIR target `runtime.decbin` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.decbin`
...
- [User reference for `decbin()`](../../../php/builtins/math/decbin.md)
