...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/math/binary.rs`:90](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/math/binary.rs#L90) (`lower_fmod`)
