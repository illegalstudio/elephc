...
- Emits the typed EIR target `runtime.bcsub` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.bcsub`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/math/bcsub.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/math/bcsub.rs) (`eval_builtin!`)
...
- [User reference for `bcsub()`](../../../php/builtins/math/bcsub.md)
