...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/math.rs`:267](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/math.rs#L267) (`lower_pi`)
