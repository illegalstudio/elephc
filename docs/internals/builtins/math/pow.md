...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/math/binary.rs`:119](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/math/binary.rs#L119) (`lower_pow`)
