...
- Emits the typed EIR target `runtime.bcmul` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.bcmul`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/math/bcmul.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/math/bcmul.rs) (`eval_builtin!`)
...
- [User reference for `bcmul()`](../../../php/builtins/math/bcmul.md)
