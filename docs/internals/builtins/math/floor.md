...
- Emits the typed EIR target `runtime.floor` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.floor`
...
- **Execution**: shared generated-runtime ABI (`RuntimeBuiltinId(8)`).
