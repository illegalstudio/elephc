...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/math/binary.rs`:65](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/math/binary.rs#L65) (`lower_fdiv`)
