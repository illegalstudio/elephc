...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:829](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L829) (`lower_is_callable`)
