...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:817](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L817) (`lower_is_callable`)
