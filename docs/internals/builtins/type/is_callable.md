...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:845](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L845) (`lower_is_callable`)
