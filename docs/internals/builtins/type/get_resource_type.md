...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/types.rs`:508](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/types.rs#L508) (`lower_get_resource_type`)
