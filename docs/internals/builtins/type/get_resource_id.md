...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/types.rs`:520](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/types.rs#L520) (`lower_get_resource_id`)
