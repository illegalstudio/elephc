...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1473](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1473) (`lower_is_object`)
