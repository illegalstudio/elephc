...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1510](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1510) (`lower_is_object`)
