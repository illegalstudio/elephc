...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1461](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1461) (`lower_is_object`)
