...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1541](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1541) (`lower_is_object`)
