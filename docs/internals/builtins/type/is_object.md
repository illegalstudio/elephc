...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1018](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1018) (`lower_is_object`)
