...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1633](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1633) (`lower_is_object`)
