...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1499](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1499) (`lower_is_object`)
