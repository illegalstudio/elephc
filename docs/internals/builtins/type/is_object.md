...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1543](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1543) (`lower_is_object`)
