...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/types/is_real.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/types/is_real.rs) (`eval_builtin!`)
- **Dispatch hooks**: `direct`, `values`

## Cross-references

- [User reference for `is_real()`](../../../php/builtins/type/is_real.md)
