...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/types/is_integer.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/types/is_integer.rs) (`eval_builtin!`)
- **Dispatch hooks**: `direct`, `values`

## Cross-references

- [User reference for `is_integer()`](../../../php/builtins/type/is_integer.md)
