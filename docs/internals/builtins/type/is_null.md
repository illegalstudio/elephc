...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1608](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1608) (`lower_is_null_builtin`)
