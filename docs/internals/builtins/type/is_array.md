...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1446](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1446) (`lower_is_array`)
