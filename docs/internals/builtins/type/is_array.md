...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1523](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1523) (`lower_is_array`)
