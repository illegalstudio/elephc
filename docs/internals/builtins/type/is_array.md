...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1003](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1003) (`lower_is_array`)
