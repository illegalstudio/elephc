...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1484](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1484) (`lower_is_array`)
