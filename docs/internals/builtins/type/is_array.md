...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1528](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1528) (`lower_is_array`)
