...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1526](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1526) (`lower_is_array`)
