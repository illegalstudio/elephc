...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1495](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1495) (`lower_is_array`)
