...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1062](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1062) (`lower_is_array`)
