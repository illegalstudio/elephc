...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1559](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1559) (`lower_is_scalar`)
