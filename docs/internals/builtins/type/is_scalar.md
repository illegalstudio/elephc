...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1557](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1557) (`lower_is_scalar`)
