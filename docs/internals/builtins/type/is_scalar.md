...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1554](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1554) (`lower_is_scalar`)
