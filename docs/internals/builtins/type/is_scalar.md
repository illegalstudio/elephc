...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1489](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1489) (`lower_is_scalar`)
