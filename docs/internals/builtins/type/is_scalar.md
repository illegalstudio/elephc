...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1477](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1477) (`lower_is_scalar`)
