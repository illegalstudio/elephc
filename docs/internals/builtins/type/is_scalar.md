...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1515](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1515) (`lower_is_scalar`)
