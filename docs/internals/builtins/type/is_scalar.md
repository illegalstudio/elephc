...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1034](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1034) (`lower_is_scalar`)
