...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1016](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1016) (`lower_intval`)
