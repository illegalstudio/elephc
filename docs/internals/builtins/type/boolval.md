...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1079](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1079) (`lower_boolval`)
