...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1191](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1191) (`lower_boolval`)
