...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1068](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1068) (`lower_boolval`)
