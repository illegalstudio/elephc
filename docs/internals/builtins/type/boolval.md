...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1110](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1110) (`lower_boolval`)
