...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1030](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1030) (`lower_boolval`)
