...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1194](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1194) (`lower_boolval`)
