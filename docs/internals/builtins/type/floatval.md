...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1080](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1080) (`lower_floatval`)
