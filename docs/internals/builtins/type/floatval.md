...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1000](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1000) (`lower_floatval`)
