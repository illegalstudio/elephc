...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1049](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1049) (`lower_floatval`)
