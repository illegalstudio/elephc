...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1287](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1287) (`lower_is_iterable`)
