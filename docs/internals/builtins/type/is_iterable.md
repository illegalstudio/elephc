...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1238](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1238) (`lower_is_iterable`)
