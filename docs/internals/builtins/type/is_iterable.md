...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1320](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1320) (`lower_is_iterable`)
