...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1409](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1409) (`lower_is_iterable`)
