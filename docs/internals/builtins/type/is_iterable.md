...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1318](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1318) (`lower_is_iterable`)
