...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1412](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1412) (`lower_is_iterable`)
