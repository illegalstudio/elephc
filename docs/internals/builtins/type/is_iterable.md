...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1315](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1315) (`lower_is_iterable`)
