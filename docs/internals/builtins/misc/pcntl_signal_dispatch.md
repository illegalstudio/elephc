...
- Emits the typed EIR target `runtime.pcntl.signal_dispatch` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.pcntl.signal_dispatch`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_signal_dispatch.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_signal_dispatch.rs) (`eval_builtin!`)
...
- [User reference for `pcntl_signal_dispatch()`](../../../php/builtins/misc/pcntl_signal_dispatch.md)
