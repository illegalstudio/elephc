...
- Emits the typed EIR target `runtime.pcntl.getpriority` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.pcntl.getpriority`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_getpriority.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_getpriority.rs) (`eval_builtin!`)
...
- [User reference for `pcntl_getpriority()`](../../../php/builtins/misc/pcntl_getpriority.md)
