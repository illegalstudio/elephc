...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:743](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L743) (`lower_defined`)
