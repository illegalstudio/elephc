...
- **Lowering**: [`src/codegen/lower_inst/builtins/count_empty.rs`:180](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/count_empty.rs#L180) (`lower_empty`)
