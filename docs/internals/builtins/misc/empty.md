...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1123](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1123) (`lower_empty`)
