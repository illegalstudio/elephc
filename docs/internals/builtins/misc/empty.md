...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:1139](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L1139) (`lower_empty`)
