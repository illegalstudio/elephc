...
- Emits the typed EIR target `runtime.pcntl.waitpid` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.pcntl.waitpid`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_waitpid.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_waitpid.rs) (`eval_builtin!`)
...
- [User reference for `pcntl_waitpid()`](../../../php/builtins/misc/pcntl_waitpid.md)
