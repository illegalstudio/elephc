...
- Emits the typed EIR target `runtime.pcntl.sigprocmask` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.pcntl.sigprocmask`
...
- **By-reference parameters**: `$old_signals`.

## Eval interpreter (magician)

- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_sigprocmask.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_sigprocmask.rs) (`eval_builtin!`)
...
- [User reference for `pcntl_sigprocmask()`](../../../php/builtins/misc/pcntl_sigprocmask.md)
