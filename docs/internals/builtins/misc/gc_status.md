...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/core/gc_status.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/core/gc_status.rs) (`eval_builtin!`)
...
- [User reference for `gc_status()`](../../../php/builtins/misc/gc_status.md)
