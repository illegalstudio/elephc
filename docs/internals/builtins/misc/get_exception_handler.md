...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/core/get_exception_handler.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/core/get_exception_handler.rs) (`eval_builtin!`)
...
- [User reference for `get_exception_handler()`](../../../php/builtins/misc/get_exception_handler.md)
