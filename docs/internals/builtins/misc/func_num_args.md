...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/core/func_num_args.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/core/func_num_args.rs) (`eval_builtin!`)
...
- [User reference for `func_num_args()`](../../../php/builtins/misc/func_num_args.md)
