...
- **Lowering**: [`src/opcache_prelude/build.rs`:811](https://github.com/illegalstudio/elephc/blob/main/src/opcache_prelude/build.rs#L811) (`opcache_is_script_cached_in_file_cache`)
