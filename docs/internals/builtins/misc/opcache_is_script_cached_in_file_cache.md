...
- **Lowering**: [`src/opcache_prelude/build.rs`:801](https://github.com/illegalstudio/elephc/blob/main/src/opcache_prelude/build.rs#L801) (`opcache_is_script_cached_in_file_cache`)
