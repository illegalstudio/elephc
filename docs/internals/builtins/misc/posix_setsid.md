...
- Emits the typed EIR target `runtime.posix.setsid` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.posix.setsid`
...
- [User reference for `posix_setsid()`](../../../php/builtins/misc/posix_setsid.md)
