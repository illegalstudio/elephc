...
- **Lowering**: [`src/codegen/lower_inst/builtins/debug.rs`:92](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/debug.rs#L92) (`lower_var_dump`)
