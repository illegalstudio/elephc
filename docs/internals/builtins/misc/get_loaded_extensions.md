...
- Emits the typed EIR target `runtime.get_loaded_extensions` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.get_loaded_extensions`
...
- [User reference for `get_loaded_extensions()`](../../../php/builtins/misc/get_loaded_extensions.md)
