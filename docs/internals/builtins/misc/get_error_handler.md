...
- **Signature**: [`src/builtins/system/get_error_handler.rs`](https://github.com/illegalstudio/elephc/blob/main/src/builtins/system/get_error_handler.rs)
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/core/get_error_handler.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/core/get_error_handler.rs) (`eval_builtin!`)
...
- [User reference for `get_error_handler()`](../../../php/builtins/misc/get_error_handler.md)
