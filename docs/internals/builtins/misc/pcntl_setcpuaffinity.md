...
- Emits the typed EIR target `runtime.pcntl.setcpuaffinity` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.pcntl.setcpuaffinity`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_setcpuaffinity.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/pcntl/pcntl_setcpuaffinity.rs) (`eval_builtin!`)
...
- [User reference for `pcntl_setcpuaffinity()`](../../../php/builtins/misc/pcntl_setcpuaffinity.md)
