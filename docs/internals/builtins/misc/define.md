...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:576](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L576) (`lower_define`)
