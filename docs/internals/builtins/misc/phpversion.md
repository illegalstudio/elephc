...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:733](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L733) (`lower_phpversion`)
