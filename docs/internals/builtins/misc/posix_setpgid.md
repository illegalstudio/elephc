...
- Emits the typed EIR target `runtime.posix.setpgid` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.posix.setpgid`
...
- [User reference for `posix_setpgid()`](../../../php/builtins/misc/posix_setpgid.md)
