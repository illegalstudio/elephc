...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1847](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1847) (`lower_array_multisort`)
