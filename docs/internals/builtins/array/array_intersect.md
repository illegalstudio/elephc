...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:879](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L879) (`lower_array_intersect`)
