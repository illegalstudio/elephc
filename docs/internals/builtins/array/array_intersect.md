...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:885](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L885) (`lower_array_intersect`)
