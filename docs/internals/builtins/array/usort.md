...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1122](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1122) (`lower_usort`)
