...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1366](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1366) (`lower_array_merge_recursive`)
