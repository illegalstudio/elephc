...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1385](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1385) (`lower_array_merge_recursive`)
