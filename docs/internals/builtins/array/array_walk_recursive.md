...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1582](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1582) (`lower_array_walk_recursive`)
