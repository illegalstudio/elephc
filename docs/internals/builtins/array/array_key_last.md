...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1167](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1167) (`lower_array_key_last`)
