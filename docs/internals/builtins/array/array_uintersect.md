...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1834](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1834) (`lower_array_uintersect`)
