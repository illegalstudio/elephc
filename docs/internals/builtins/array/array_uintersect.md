...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1839](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1839) (`lower_array_uintersect`)
