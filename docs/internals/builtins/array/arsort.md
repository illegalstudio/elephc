...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1092](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1092) (`lower_arsort`)
