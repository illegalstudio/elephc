...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1076](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1076) (`lower_sort`)
