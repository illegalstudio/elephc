...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1907](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1907) (`lower_in_array`)
