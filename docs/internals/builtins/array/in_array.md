...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1902](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1902) (`lower_in_array`)
