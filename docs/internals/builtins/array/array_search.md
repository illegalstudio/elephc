...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1881](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1881) (`lower_array_search`)
