...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1343](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1343) (`lower_array_replace_recursive`)
