...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1101](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1101) (`lower_krsort`)
