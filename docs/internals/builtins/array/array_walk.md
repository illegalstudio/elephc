...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:889](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L889) (`lower_array_walk`)
