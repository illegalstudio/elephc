...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:890](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L890) (`lower_array_walk`)
