...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1523](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1523) (`lower_array_diff_assoc`)
