...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1357](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1357) (`lower_array_diff_assoc`)
