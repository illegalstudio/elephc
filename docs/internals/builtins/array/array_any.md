...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1571](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1571) (`lower_array_any`)
