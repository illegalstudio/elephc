...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1148](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1148) (`lower_array_is_list`)
