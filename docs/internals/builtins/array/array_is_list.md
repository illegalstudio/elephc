...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1320](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1320) (`lower_array_is_list`)
