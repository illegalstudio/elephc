...
- **Signature**: [`src/builtins/array/reset.rs`](https://github.com/illegalstudio/elephc/blob/main/src/builtins/array/reset.rs)
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/array/reset.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/array/reset.rs) (`eval_builtin!`)
...
- [User reference for `reset()`](../../../php/builtins/array/reset.md)
