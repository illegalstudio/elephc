...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1155](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1155) (`lower_array_key_first`)
