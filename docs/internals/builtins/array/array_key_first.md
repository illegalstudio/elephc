...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1331](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1331) (`lower_array_key_first`)
