...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1159](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1159) (`lower_array_key_first`)
