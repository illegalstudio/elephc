...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1338](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1338) (`lower_array_replace`)
