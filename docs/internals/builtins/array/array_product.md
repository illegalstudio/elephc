...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:56](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L56) (`lower_array_product`)
