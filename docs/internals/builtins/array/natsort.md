...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1106](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1106) (`lower_natsort`)
