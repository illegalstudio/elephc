...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:1282](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L1282) (`lower_natsort`)
