...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1107](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1107) (`lower_natsort`)
