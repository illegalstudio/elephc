...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1082](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1082) (`lower_rsort`)
