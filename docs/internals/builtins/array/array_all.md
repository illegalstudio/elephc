...
- **Lowering**: [`src/codegen/lower_inst/builtins/arrays.rs`:1536](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/arrays.rs#L1536) (`lower_array_all`)
