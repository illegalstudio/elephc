...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/arrays.rs`:997](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/arrays.rs#L997) (`lower_array_diff`)
