...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins.rs`:805](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins.rs#L805) (`lower_function_exists`)
