...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4427](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4427) (`lower_rmdir`)
