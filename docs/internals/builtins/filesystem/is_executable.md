...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5629](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5629) (`lower_is_executable`)
