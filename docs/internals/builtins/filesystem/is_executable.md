...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4981](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4981) (`lower_is_executable`)
