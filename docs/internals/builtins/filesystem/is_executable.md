...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5626](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5626) (`lower_is_executable`)
