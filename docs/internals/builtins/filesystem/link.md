...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5450](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5450) (`lower_link`)
