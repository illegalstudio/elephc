...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4802](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4802) (`lower_link`)
