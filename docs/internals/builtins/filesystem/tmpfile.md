...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5410](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5410) (`lower_tmpfile`)
