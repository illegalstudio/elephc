...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5413](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5413) (`lower_tmpfile`)
