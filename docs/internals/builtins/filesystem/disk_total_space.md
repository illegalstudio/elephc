...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3376](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3376) (`lower_disk_total_space`)
