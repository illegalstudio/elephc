...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3375](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3375) (`lower_disk_total_space`)
