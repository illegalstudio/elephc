...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3379](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3379) (`lower_disk_total_space`)
