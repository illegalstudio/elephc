...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4474](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4474) (`lower_chown`)
