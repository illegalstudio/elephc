...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4467](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4467) (`lower_chown`)
