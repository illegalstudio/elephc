...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4470](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4470) (`lower_chown`)
