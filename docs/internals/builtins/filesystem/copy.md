...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4437](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4437) (`lower_copy`)
