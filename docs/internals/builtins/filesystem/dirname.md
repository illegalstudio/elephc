...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4569](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4569) (`lower_dirname`)
