...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4460](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4460) (`lower_glob`)
