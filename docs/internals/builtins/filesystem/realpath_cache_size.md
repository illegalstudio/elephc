...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3477](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3477) (`lower_realpath_cache_size`)
