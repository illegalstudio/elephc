...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3711](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3711) (`lower_realpath_cache_size`)
