...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4469](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4469) (`lower_chmod`)
