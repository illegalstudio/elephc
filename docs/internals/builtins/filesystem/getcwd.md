...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5390](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5390) (`lower_getcwd`)
