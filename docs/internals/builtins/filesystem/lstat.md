...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5535](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5535) (`lower_lstat`)
