...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5528](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5528) (`lower_lstat`)
