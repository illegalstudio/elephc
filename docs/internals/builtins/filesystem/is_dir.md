...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5597](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5597) (`lower_is_dir`)
