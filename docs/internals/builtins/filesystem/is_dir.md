...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5601](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5601) (`lower_is_dir`)
