...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4949](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4949) (`lower_is_dir`)
