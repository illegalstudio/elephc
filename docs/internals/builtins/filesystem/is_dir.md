...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5594](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5594) (`lower_is_dir`)
