...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5602](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5602) (`lower_is_readable`)
