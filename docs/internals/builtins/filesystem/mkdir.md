...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4429](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4429) (`lower_mkdir`)
