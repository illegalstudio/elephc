...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4645](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4645) (`lower_pathinfo`)
