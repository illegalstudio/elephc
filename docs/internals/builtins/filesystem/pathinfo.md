...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4641](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4641) (`lower_pathinfo`)
