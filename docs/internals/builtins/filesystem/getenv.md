...
- **Lowering**: [`src/codegen/lower_inst/builtins/system.rs`:685](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/system.rs#L685) (`lower_getenv`)
