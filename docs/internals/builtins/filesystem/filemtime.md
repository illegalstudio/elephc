...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5426](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5426) (`lower_filemtime`)
