...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4396](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4396) (`lower_file_exists`)
