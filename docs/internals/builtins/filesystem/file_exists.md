...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3748](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3748) (`lower_file_exists`)
