...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4400](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4400) (`lower_file_exists`)
