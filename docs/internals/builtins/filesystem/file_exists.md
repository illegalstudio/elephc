...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4393](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4393) (`lower_file_exists`)
