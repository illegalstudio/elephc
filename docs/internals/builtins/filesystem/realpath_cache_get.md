...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3694](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3694) (`lower_realpath_cache_get`)
