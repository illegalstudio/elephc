...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5501](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5501) (`lower_filegroup`)
