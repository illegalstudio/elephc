...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5575](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5575) (`lower_clearstatcache`)
