...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5418](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5418) (`lower_filesize`)
