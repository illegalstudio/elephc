...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5421](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5421) (`lower_filesize`)
