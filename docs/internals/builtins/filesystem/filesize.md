...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5425](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5425) (`lower_filesize`)
