...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3141](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3141) (`lower_disk_free_space`)
