...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3367](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3367) (`lower_disk_free_space`)
