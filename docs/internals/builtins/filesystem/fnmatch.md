...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4604](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4604) (`lower_fnmatch`)
