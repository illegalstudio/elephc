...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4597](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4597) (`lower_fnmatch`)
