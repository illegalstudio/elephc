...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4941](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4941) (`lower_is_file`)
