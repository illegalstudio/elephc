...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5442](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5442) (`lower_symlink`)
