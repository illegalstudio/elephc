...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4408](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4408) (`lower_unlink`)
