...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4401](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4401) (`lower_unlink`)
