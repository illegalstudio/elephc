...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5523](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5523) (`lower_stat`)
