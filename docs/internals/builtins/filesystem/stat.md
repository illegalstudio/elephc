...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5530](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5530) (`lower_stat`)
