...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4485](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4485) (`lower_lchgrp`)
