...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5617](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5617) (`lower_is_writable`)
