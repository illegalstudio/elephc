...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4530](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4530) (`lower_basename`)
