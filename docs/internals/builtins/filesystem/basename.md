...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4537](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4537) (`lower_basename`)
