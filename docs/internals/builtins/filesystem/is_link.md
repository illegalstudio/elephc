...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5637](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5637) (`lower_is_link`)
