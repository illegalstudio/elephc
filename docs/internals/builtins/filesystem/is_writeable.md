...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:5625](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L5625) (`lower_is_writeable`)
