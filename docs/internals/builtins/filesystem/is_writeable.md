...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:5618](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L5618) (`lower_is_writeable`)
