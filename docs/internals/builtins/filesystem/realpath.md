...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3687](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3687) (`lower_realpath`)
