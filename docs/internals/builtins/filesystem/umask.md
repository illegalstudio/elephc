...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4490](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4490) (`lower_umask`)
