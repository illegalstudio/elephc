...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4494](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4494) (`lower_umask`)
