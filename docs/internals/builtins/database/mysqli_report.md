...
- **Lowering**: [`src/mysqli_prelude/build/exception.rs`:81](https://github.com/illegalstudio/elephc/blob/main/src/mysqli_prelude/build/exception.rs#L81) (`mysqli_report`)
