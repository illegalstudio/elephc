...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/strings.rs`:729](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/strings.rs#L729) (`lower_substr_replace`)
