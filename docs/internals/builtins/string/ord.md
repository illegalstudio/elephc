...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/strings.rs`:833](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/strings.rs#L833) (`lower_ord`)
