...
- Emits the typed EIR target `runtime.iconv_mime_decode` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.iconv_mime_decode`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/string/iconv_mime_decode.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/string/iconv_mime_decode.rs) (`eval_builtin!`)
...
- [User reference for `iconv_mime_decode()`](../../../php/builtins/string/iconv_mime_decode.md)
