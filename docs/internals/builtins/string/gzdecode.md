---
title: "gzdecode() — internals"
description: "Compiler internals for gzdecode(): lowering path, type checks, and runtime helpers."
sidebar:
  order: 461
---
...
- [User reference for `gzdecode()`](../../../php/builtins/string/gzdecode.md)
