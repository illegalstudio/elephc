...
- **Signature**: [`src/builtins/string/str_getcsv.rs`](https://github.com/illegalstudio/elephc/blob/main/src/builtins/string/str_getcsv.rs)
...
- Emits the typed EIR target `runtime.str_getcsv` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.str_getcsv`
...
- [User reference for `str_getcsv()`](../../../php/builtins/string/str_getcsv.md)
