...
- Emits the typed EIR target `runtime.iconv_mime_decode_headers` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.iconv_mime_decode_headers`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/string/iconv_mime_decode_headers.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/string/iconv_mime_decode_headers.rs) (`eval_builtin!`)
...
- [User reference for `iconv_mime_decode_headers()`](../../../php/builtins/string/iconv_mime_decode_headers.md)
