...
- Emits the typed EIR target `runtime.iconv_strlen` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.iconv_strlen`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/string/iconv_strlen.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/string/iconv_strlen.rs) (`eval_builtin!`)
...
- [User reference for `iconv_strlen()`](../../../php/builtins/string/iconv_strlen.md)
