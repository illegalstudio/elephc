...
- Emits the typed EIR target `runtime.parse_url` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.parse_url`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/string/parse_url.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/string/parse_url.rs) (`eval_builtin!`)
...
- [User reference for `parse_url()`](../../../php/builtins/string/parse_url.md)
