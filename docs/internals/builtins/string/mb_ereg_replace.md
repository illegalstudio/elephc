...
- Emits the typed EIR target `runtime.mb_ereg_replace` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.mb_ereg_replace`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/string/mb_ereg_replace.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/string/mb_ereg_replace.rs) (`eval_builtin!`)
- **Execution**: shared generated-runtime ABI (`RuntimeBuiltinId(78)`).
- **Dispatch hooks**: _none_ (shared runtime dispatch)

## Cross-references

- [User reference for `mb_ereg_replace()`](../../../php/builtins/string/mb_ereg_replace.md)
