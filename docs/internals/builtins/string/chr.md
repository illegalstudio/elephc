...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/strings.rs`:857](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/strings.rs#L857) (`lower_chr`)
