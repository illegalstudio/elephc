...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/strings.rs`:874](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/strings.rs#L874) (`lower_number_format`)
