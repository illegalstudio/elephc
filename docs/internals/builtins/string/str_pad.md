...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/strings.rs`:817](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/strings.rs#L817) (`lower_str_pad`)
