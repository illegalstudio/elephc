...
- Emits the typed EIR target `runtime.iconv_get_encoding` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.iconv_get_encoding`
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/string/iconv_get_encoding.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/string/iconv_get_encoding.rs) (`eval_builtin!`)
...
- [User reference for `iconv_get_encoding()`](../../../php/builtins/string/iconv_get_encoding.md)
