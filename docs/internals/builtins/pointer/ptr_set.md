...
- **Lowering**: [`src/codegen/lower_inst/builtins/pointers.rs`:268](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/pointers.rs#L268) (`lower_ptr_set`)
