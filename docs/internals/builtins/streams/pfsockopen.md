...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3645](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3645) (`lower_fsockopen`)
