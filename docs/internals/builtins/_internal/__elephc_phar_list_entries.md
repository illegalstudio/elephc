...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4278](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4278) (`lower_elephc_phar_list_entries`)
