...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4143](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4143) (`lower_elephc_phar_sign_openssl`)
