...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4150](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4150) (`lower_elephc_phar_sign_openssl`)
