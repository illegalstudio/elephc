...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3870](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3870) (`lower_elephc_phar_get_stub`)
