...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3867](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3867) (`lower_elephc_phar_get_stub`)
