...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3797](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3797) (`lower_elephc_phar_set_compression`)
