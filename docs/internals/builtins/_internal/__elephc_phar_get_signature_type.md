...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4202](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4202) (`lower_elephc_phar_get_signature_type`)
