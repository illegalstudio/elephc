...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4203](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4203) (`lower_elephc_phar_get_signature_type`)
