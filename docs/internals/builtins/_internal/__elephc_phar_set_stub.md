...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3897](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3897) (`lower_elephc_phar_set_stub`)
