...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4136](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4136) (`lower_elephc_phar_decompress_archive`)
