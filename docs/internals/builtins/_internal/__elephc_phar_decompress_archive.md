...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4131](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4131) (`lower_elephc_phar_decompress_archive`)
