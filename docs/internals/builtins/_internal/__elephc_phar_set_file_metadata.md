...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4091](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4091) (`lower_elephc_phar_set_file_metadata`)
