...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4086](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4086) (`lower_elephc_phar_set_file_metadata`)
