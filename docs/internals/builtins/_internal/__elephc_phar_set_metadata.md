...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3876](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3876) (`lower_elephc_phar_set_metadata`)
