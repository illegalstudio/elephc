...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3883](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3883) (`lower_elephc_phar_set_metadata`)
