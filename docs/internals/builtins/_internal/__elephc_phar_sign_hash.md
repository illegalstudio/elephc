...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4157](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4157) (`lower_elephc_phar_sign_hash`)
