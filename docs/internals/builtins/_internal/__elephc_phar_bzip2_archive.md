...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4121](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4121) (`lower_elephc_phar_bzip2_archive`)
