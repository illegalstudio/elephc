...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:4117](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L4117) (`lower_elephc_phar_bzip2_archive`)
