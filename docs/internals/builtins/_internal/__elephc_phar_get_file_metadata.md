...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4074](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4074) (`lower_elephc_phar_get_file_metadata`)
