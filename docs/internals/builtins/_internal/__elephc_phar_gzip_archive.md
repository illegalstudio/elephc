...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:4099](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L4099) (`lower_elephc_phar_gzip_archive`)
