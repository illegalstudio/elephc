...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3860](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3860) (`lower_elephc_phar_get_metadata`)
