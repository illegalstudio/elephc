...
- **Lowering**: [`src/codegen/lower_inst/builtins/regex.rs`:52](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/regex.rs#L52) (`lower_preg_match_all`)
