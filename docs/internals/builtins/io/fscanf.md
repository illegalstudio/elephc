...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2709](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2709) (`lower_fscanf`)
