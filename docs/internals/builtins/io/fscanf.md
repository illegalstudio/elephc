...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2936](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2936) (`lower_fscanf`)
