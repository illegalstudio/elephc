...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2937](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2937) (`lower_fscanf`)
