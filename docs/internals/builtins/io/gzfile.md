...
- **Lowering**: [`src/gz_prelude.rs`:264](https://github.com/illegalstudio/elephc/blob/main/src/gz_prelude.rs#L264) (`gzfile`)
- **Function symbol**: `gzfile()`
...
- [User reference for `gzfile()`](../../../php/builtins/io/gzfile.md)
