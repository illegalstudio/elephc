...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3585](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3585) (`lower_rewinddir`)
