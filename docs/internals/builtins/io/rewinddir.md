...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3584](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3584) (`lower_rewinddir`)
