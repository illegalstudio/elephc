...
- Emits the typed EIR target `runtime.ob_clean` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.ob_clean`
...
- **Execution**: shared generated-runtime ABI (`RuntimeBuiltinId(18)`).
