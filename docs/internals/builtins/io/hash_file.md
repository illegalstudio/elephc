...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:172](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L172) (`lower_hash_file`)
