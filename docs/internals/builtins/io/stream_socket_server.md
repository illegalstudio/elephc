...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2147](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2147) (`lower_stream_socket_server`)
