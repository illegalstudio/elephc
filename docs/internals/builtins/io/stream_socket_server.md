...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2373](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2373) (`lower_stream_socket_server`)
