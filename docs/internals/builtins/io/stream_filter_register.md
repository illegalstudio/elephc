...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1400](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1400) (`lower_stream_filter_register`)
