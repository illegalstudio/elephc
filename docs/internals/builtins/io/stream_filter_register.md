...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1520](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1520) (`lower_stream_filter_register`)
