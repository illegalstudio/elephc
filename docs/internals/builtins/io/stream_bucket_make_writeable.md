...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1985](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1985) (`lower_stream_bucket_make_writeable`)
