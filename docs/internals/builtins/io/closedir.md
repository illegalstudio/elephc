...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3570](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3570) (`lower_closedir`)
