...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3343](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3343) (`lower_closedir`)
