...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3573](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3573) (`lower_closedir`)
