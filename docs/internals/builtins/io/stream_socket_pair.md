...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2238](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2238) (`lower_stream_socket_pair`)
