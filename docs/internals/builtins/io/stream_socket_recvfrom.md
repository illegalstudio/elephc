...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2598](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2598) (`lower_stream_socket_recvfrom`)
