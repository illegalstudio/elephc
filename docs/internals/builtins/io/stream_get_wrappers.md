...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1340](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1340) (`lower_stream_get_wrappers`)
