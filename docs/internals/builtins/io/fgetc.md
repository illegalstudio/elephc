...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2981](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2981) (`lower_fgetc`)
