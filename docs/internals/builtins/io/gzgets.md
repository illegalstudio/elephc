...
- **Lowering**: [`src/gz_prelude.rs`:109](https://github.com/illegalstudio/elephc/blob/main/src/gz_prelude.rs#L109) (`gzgets`)
- **Function symbol**: `gzgets()`
...
- [User reference for `gzgets()`](../../../php/builtins/io/gzgets.md)
