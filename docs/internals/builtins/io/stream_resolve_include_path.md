...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2134](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2134) (`lower_stream_resolve_include_path`)
