...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2360](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2360) (`lower_stream_resolve_include_path`)
