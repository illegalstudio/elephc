...
- Emits the typed EIR target `runtime.ob_flush` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.ob_flush`
...
- **Execution**: shared generated-runtime ABI (`RuntimeBuiltinId(19)`).
