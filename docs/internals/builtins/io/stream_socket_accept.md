...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2209](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2209) (`lower_stream_socket_accept`)
