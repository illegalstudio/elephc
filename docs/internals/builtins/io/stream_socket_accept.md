...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2435](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2435) (`lower_stream_socket_accept`)
