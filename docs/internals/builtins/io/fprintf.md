...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2861](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2861) (`lower_fprintf`)
