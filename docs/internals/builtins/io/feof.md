...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3119](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3119) (`lower_feof`)
