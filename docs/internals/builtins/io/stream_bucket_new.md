...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1969](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1969) (`lower_stream_bucket_new`)
