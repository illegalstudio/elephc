...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1272](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1272) (`lower_stream_get_line`)
