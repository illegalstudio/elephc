...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1876](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1876) (`lower_stream_is_local`)
