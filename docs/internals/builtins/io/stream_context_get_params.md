...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1289](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1289) (`lower_stream_context_get_params`)
