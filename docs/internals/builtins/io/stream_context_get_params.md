...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1170](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1170) (`lower_stream_context_get_params`)
