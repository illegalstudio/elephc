...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2269](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2269) (`lower_stream_socket_get_name`)
