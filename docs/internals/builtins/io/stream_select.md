...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2089](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2089) (`lower_stream_select`)
