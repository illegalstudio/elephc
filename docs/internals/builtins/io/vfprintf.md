...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2669](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2669) (`lower_vfprintf`)
