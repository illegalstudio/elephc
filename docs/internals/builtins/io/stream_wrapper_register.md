...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:998](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L998) (`lower_stream_wrapper_register`)
