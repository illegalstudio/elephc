...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:879](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L879) (`lower_stream_wrapper_register`)
