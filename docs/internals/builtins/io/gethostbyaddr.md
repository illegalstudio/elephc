...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3429](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3429) (`lower_gethostbyaddr`)
