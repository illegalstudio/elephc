...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3427](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3427) (`lower_gethostbyaddr`)
