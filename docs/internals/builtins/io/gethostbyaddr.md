...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3428](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3428) (`lower_gethostbyaddr`)
