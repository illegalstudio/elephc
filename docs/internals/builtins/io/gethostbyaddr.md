...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3202](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3202) (`lower_gethostbyaddr`)
