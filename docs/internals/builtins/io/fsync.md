...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3262](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3262) (`lower_fsync`)
