...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3259](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3259) (`lower_fsync`)
