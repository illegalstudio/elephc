...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3032](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3032) (`lower_fsync`)
