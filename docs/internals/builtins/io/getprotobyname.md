...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3441](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3441) (`lower_getprotobyname`)
