...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3442](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3442) (`lower_getprotobyname`)
