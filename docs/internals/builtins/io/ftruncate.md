...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2981](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2981) (`lower_ftruncate`)
