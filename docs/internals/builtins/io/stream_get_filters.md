...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1492](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1492) (`lower_stream_get_filters`)
