...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3238](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3238) (`lower_getprotobynumber`)
