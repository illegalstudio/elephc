...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2837](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2837) (`lower_fwrite`)
