...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:2609](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L2609) (`lower_fwrite`)
