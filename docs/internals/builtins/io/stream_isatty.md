...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2125](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2125) (`lower_stream_isatty`)
