...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1087](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1087) (`lower_stream_context_set_default`)
