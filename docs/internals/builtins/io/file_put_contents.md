...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3728](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3728) (`lower_file_put_contents`)
