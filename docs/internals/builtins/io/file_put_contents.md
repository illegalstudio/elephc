...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3721](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3721) (`lower_file_put_contents`)
