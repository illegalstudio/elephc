...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3724](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3724) (`lower_file_put_contents`)
