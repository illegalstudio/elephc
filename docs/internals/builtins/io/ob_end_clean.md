...
- **Lowering**: [`src/codegen/lower_inst/builtins/output_buffering.rs`:124](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/output_buffering.rs#L124) (`lower_ob_end_clean`)
