...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1712](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1712) (`lower_stream_filter_remove`)
