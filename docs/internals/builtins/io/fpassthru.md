...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3025](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3025) (`lower_fpassthru`)
