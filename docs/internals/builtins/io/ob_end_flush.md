...
- **Lowering**: [`src/codegen/lower_inst/builtins/output_buffering.rs`:448](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/output_buffering.rs#L448) (`lower_ob_end_flush`)
