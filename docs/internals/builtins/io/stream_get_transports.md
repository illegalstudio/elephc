...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1476](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1476) (`lower_stream_get_transports`)
