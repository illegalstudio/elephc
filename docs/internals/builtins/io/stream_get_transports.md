...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1356](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1356) (`lower_stream_get_transports`)
