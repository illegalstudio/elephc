...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3130](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3130) (`lower_ftell`)
