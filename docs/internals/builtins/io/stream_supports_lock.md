...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1888](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1888) (`lower_stream_supports_lock`)
