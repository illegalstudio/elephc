...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:943](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L943) (`lower_stream_context_create`)
