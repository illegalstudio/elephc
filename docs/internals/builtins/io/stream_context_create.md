...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1062](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1062) (`lower_stream_context_create`)
