...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3555](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3555) (`lower_readdir`)
