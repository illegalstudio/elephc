...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3170](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3170) (`lower_fseek`)
