...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:3180](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L3180) (`lower_gethostname`)
