...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3410](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3410) (`lower_gethostname`)
