...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1077](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1077) (`lower_stream_context_get_default`)
