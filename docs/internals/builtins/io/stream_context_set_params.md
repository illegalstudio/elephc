...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1117](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1117) (`lower_stream_context_set_params`)
