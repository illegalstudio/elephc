...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2968](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2968) (`lower_fgets`)
