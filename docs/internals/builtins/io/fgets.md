...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2966](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2966) (`lower_fgets`)
