...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:1358](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L1358) (`lower_stream_copy_to_stream`)
