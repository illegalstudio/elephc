...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/io.rs`:1180](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/io.rs#L1180) (`lower_stream_get_contents`)
