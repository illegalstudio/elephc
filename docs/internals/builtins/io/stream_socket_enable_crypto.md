...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2546](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2546) (`lower_stream_socket_enable_crypto`)
