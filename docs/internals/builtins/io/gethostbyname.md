...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:3420](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L3420) (`lower_gethostbyname`)
