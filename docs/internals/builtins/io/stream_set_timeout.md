...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2265](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2265) (`lower_stream_set_timeout`)
