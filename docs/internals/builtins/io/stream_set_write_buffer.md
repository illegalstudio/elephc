...
- **Lowering**: [`src/codegen/lower_inst/builtins/io.rs`:2253](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/io.rs#L2253) (`lower_stream_set_buffer`)
