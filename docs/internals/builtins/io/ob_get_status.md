...
- **Lowering**: [`src/codegen/lower_inst/builtins/output_buffering.rs`:181](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins/output_buffering.rs#L181) (`lower_ob_get_status`)
