...
- **Lowering**: [`src/name_resolver/expressions.rs`:871](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L871) (`rewrite_date_procedural_call`)
