...
- **Lowering**: [`src/name_resolver/expressions.rs`:632](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L632) (`rewrite_date_procedural_call`)
...
- [User reference for `date_create_immutable_from_format()`](../../../php/builtins/date/date_create_immutable_from_format.md)
