...
- **Lowering**: [`src/name_resolver/expressions.rs`:911](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L911) (`rewrite_date_procedural_call`)
