...
- **Lowering**: [`src/name_resolver/expressions.rs`:1113](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1113) (`rewrite_date_procedural_call`)
...
- [User reference for `date_interval_format()`](../../../php/builtins/date/date_interval_format.md)
