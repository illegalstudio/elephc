...
- Emits the typed EIR target `runtime.gmmktime` through `BuiltinLoweringContext`.
...
- **Typed EIR target**: `runtime.gmmktime`
- **Backend boundary**: `src/codegen/lower_inst/runtime_calls.rs` resolves the typed target without PHP-name dispatch.

## Signature summary

```php
function gmmktime(int $hour, ?int $minute = null, ?int $second = null, ?int $month = null, ?int $day = null, ?int $year = null): mixed
```
