...
- **Lowering**: [`src/name_resolver/expressions.rs`:570](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L570) (`rewrite_date_procedural_call`)
...
- [User reference for `idate()`](../../../php/builtins/date/idate.md)
