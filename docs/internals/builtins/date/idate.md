...
- **Lowering**: [`src/name_resolver/expressions.rs`:616](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L616) (`rewrite_date_procedural_call`)
