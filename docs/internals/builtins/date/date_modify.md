...
- **Lowering**: [`src/name_resolver/expressions.rs`:1082](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1082) (`rewrite_date_procedural_call`)
...
- [User reference for `date_modify()`](../../../php/builtins/date/date_modify.md)
