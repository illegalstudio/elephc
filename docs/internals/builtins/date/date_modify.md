...
- **Lowering**: [`src/name_resolver/expressions.rs`:848](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L848) (`rewrite_date_procedural_call`)
