...
- **Lowering**: [`src/name_resolver/expressions.rs`:639](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L639) (`rewrite_date_procedural_call`)
...
- [User reference for `date_sun_info()`](../../../php/builtins/date/date_sun_info.md)
