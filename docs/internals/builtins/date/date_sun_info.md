...
- **Lowering**: [`src/name_resolver/expressions.rs`:867](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L867) (`rewrite_date_procedural_call`)
