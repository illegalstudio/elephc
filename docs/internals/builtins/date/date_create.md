...
- **Lowering**: [`src/name_resolver/expressions.rs`:627](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L627) (`rewrite_date_procedural_call`)
...
- [User reference for `date_create()`](../../../php/builtins/date/date_create.md)
