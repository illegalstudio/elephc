...
- **Lowering**: [`src/name_resolver/expressions.rs`:652](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L652) (`rewrite_date_procedural_call`)
