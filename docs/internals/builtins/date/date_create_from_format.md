...
- **Lowering**: [`src/name_resolver/expressions.rs`:845](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L845) (`rewrite_date_procedural_call`)
