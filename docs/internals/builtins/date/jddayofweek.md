...
- **Lowering**: [`src/name_resolver/expressions.rs`:667](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L667) (`rewrite_date_procedural_call`)
...
- [User reference for `jddayofweek()`](../../../php/builtins/date/jddayofweek.md)
