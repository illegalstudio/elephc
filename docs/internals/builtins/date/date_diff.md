...
- **Lowering**: [`src/name_resolver/expressions.rs`:1067](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1067) (`rewrite_date_procedural_call`)
...
- [User reference for `date_diff()`](../../../php/builtins/date/date_diff.md)
