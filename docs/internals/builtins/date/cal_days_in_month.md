...
- **Lowering**: [`src/name_resolver/expressions.rs`:672](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L672) (`rewrite_date_procedural_call`)
