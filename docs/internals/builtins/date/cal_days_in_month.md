...
- **Lowering**: [`src/name_resolver/expressions.rs`:649](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L649) (`rewrite_date_procedural_call`)
...
- [User reference for `cal_days_in_month()`](../../../php/builtins/date/cal_days_in_month.md)
