...
- **Lowering**: [`src/name_resolver/expressions.rs`:877](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L877) (`rewrite_date_procedural_call`)
