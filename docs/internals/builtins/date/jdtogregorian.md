...
- **Lowering**: [`src/name_resolver/expressions.rs`:656](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L656) (`rewrite_date_procedural_call`)
...
- [User reference for `jdtogregorian()`](../../../php/builtins/date/jdtogregorian.md)
