...
- **Lowering**: [`src/name_resolver/expressions.rs`:788](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L788) (`rewrite_date_procedural_call`)
