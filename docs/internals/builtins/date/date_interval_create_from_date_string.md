...
- **Lowering**: [`src/name_resolver/expressions.rs`:840](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L840) (`rewrite_date_procedural_call`)
