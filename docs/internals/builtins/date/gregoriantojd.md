...
- **Lowering**: [`src/name_resolver/expressions.rs`:653](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L653) (`rewrite_date_procedural_call`)
...
- [User reference for `gregoriantojd()`](../../../php/builtins/date/gregoriantojd.md)
