...
- **Lowering**: [`src/name_resolver/expressions.rs`:1094](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1094) (`rewrite_date_procedural_call`)
...
- [User reference for `date_timestamp_get()`](../../../php/builtins/date/date_timestamp_get.md)
