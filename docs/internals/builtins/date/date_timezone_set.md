...
- **Lowering**: [`src/name_resolver/expressions.rs`:852](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L852) (`rewrite_date_procedural_call`)
