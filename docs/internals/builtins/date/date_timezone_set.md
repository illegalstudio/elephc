...
- **Lowering**: [`src/name_resolver/expressions.rs`:1108](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1108) (`rewrite_date_procedural_call`)
...
- [User reference for `date_timezone_set()`](../../../php/builtins/date/date_timezone_set.md)
