...
- **Lowering**: [`src/codegen_ir/lower_inst/builtins/system.rs`:544](https://github.com/illegalstudio/elephc/blob/main/src/codegen_ir/lower_inst/builtins/system.rs#L544) (`lower_time`)
