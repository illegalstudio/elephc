...
- **Lowering**: [`src/name_resolver/expressions.rs`:659](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L659) (`rewrite_date_procedural_call`)
...
- [User reference for `juliantojd()`](../../../php/builtins/date/juliantojd.md)
