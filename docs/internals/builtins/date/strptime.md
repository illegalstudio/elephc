...
- **Lowering**: [`src/name_resolver/expressions.rs`:642](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L642) (`rewrite_date_procedural_call`)
...
- [User reference for `strptime()`](../../../php/builtins/date/strptime.md)
