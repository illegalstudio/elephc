...
- **Lowering**: [`src/name_resolver/expressions.rs`:870](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L870) (`rewrite_date_procedural_call`)
