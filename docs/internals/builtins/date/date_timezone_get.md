...
- **Lowering**: [`src/name_resolver/expressions.rs`:805](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L805) (`rewrite_date_procedural_call`)
...
- [User reference for `date_timezone_get()`](../../../php/builtins/date/date_timezone_get.md)
