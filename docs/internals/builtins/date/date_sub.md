...
- **Lowering**: [`src/name_resolver/expressions.rs`:824](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L824) (`rewrite_date_procedural_call`)
