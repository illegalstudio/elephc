...
- **Lowering**: [`src/name_resolver/expressions.rs`:789](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L789) (`rewrite_date_procedural_call`)
