...
- **Lowering**: [`src/name_resolver/expressions.rs`:1050](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1050) (`rewrite_date_procedural_call`)
...
- [User reference for `timezone_version_get()`](../../../php/builtins/date/timezone_version_get.md)
