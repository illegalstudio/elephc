...
- **Lowering**: [`src/name_resolver/expressions.rs`:820](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L820) (`rewrite_date_procedural_call`)
