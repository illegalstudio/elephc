...
- **Lowering**: [`src/name_resolver/expressions.rs`:774](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L774) (`rewrite_date_procedural_call`)
...
- [User reference for `timezone_open()`](../../../php/builtins/date/timezone_open.md)
