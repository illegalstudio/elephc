...
- **Lowering**: [`src/name_resolver/expressions.rs`:869](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L869) (`rewrite_date_procedural_call`)
