...
- **Lowering**: [`src/name_resolver/expressions.rs`:664](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L664) (`rewrite_date_procedural_call`)
...
- [User reference for `jdtojewish()`](../../../php/builtins/date/jdtojewish.md)
