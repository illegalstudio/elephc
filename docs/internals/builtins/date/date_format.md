...
- **Lowering**: [`src/name_resolver/expressions.rs`:1068](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1068) (`rewrite_date_procedural_call`)
