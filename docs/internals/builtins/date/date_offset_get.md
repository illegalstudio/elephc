...
- **Lowering**: [`src/name_resolver/expressions.rs`:1109](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1109) (`rewrite_date_procedural_call`)
...
- [User reference for `date_offset_get()`](../../../php/builtins/date/date_offset_get.md)
