...
- **Lowering**: [`src/name_resolver/expressions.rs`:674](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L674) (`rewrite_date_procedural_call`)
...
- [User reference for `unixtojd()`](../../../php/builtins/date/unixtojd.md)
