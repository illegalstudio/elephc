...
- **Lowering**: [`src/name_resolver/expressions.rs`:663](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L663) (`rewrite_date_procedural_call`)
...
- [User reference for `jewishtojd()`](../../../php/builtins/date/jewishtojd.md)
