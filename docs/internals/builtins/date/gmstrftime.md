...
- **Lowering**: [`src/name_resolver/expressions.rs`:796](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L796) (`rewrite_date_procedural_call`)
