...
- **Lowering**: [`src/name_resolver/expressions.rs`:750](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L750) (`rewrite_date_procedural_call`)
...
- [User reference for `gmstrftime()`](../../../php/builtins/date/gmstrftime.md)
