...
- **Lowering**: [`src/name_resolver/expressions.rs`:741](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L741) (`rewrite_date_procedural_call`)
...
- [User reference for `gettimeofday()`](../../../php/builtins/date/gettimeofday.md)
