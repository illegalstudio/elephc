...
- **Lowering**: [`src/name_resolver/expressions.rs`:850](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L850) (`rewrite_date_procedural_call`)
