---
title: "date_timestamp_set() — internals"
description: "Compiler internals for date_timestamp_set(): lowering path, type checks, and runtime helpers."
sidebar:
  order: 214
---

## `date_timestamp_set()` — internals

## Where it lives

- **Signature**: [`crates/elephc-builtin-contract/src/catalog_surfaces.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-builtin-contract/src/catalog_surfaces.rs)
- **Lowering**: [`src/name_resolver/expressions.rs`:1095](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L1095) (`rewrite_date_procedural_call`)
...
- [User reference for `date_timestamp_set()`](../../../php/builtins/date/date_timestamp_set.md)
