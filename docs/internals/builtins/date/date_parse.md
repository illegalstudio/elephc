...
- **Lowering**: [`src/name_resolver/expressions.rs`:866](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L866) (`rewrite_date_procedural_call`)
