...
- **Lowering**: [`src/name_resolver/expressions.rs`:638](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L638) (`rewrite_date_procedural_call`)
...
- [User reference for `date_parse()`](../../../php/builtins/date/date_parse.md)
