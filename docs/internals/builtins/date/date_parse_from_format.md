...
- **Lowering**: [`src/name_resolver/expressions.rs`:635](https://github.com/illegalstudio/elephc/blob/main/src/name_resolver/expressions.rs#L635) (`rewrite_date_procedural_call`)
...
- [User reference for `date_parse_from_format()`](../../../php/builtins/date/date_parse_from_format.md)
