...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1307](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1307) (`xmlwriter_write_dtd`)
