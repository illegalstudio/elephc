...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1245](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1245) (`xmlwriter_start_document`)
