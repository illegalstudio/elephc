...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1334](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1334) (`xmlwriter_end_dtd_element`)
