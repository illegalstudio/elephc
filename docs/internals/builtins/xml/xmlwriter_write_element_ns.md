...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1155](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1155) (`xmlwriter_write_element_ns`)
