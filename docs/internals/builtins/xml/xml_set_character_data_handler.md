...
- **Signature**: [`src/builtins/xml/xml_set_character_data_handler.rs`](https://github.com/illegalstudio/elephc/blob/main/src/builtins/xml/xml_set_character_data_handler.rs)
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/xml/xml_set_character_data_handler.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/xml/xml_set_character_data_handler.rs) (`eval_builtin!`)
...
- [User reference for `xml_set_character_data_handler()`](../../../php/builtins/xml/xml_set_character_data_handler.md)
