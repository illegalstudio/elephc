...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1198](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1198) (`xmlwriter_end_cdata`)
