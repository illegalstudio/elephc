...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1079](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1079) (`xmlwriter_write_attribute_ns`)
