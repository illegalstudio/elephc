...
- **Lowering**: [`src/xml_prelude/build/parser.rs`:1520](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/parser.rs#L1520) (`xml_get_error_code`)
