...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:964](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L964) (`xmlwriter_set_indent`)
