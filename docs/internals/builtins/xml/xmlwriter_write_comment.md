...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1270](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1270) (`xmlwriter_write_comment`)
