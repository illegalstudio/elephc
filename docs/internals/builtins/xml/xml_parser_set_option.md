...
- **Lowering**: [`src/xml_prelude/build/parser.rs`:1594](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/parser.rs#L1594) (`xml_parser_set_option`)
