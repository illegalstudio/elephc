...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:952](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L952) (`xmlwriter_open_memory`)
