...
- **Lowering**: [`src/xml_prelude/build/parser.rs`:1564](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/parser.rs#L1564) (`xml_get_current_byte_index`)
