...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1151](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1151) (`xmlwriter_start_pi`)
