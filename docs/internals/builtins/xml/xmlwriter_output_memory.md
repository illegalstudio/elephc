...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1454](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1454) (`xmlwriter_output_memory`)
