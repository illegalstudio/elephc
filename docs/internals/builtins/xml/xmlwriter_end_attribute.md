...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/xml/xmlwriter_end_attribute.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/xml/xmlwriter_end_attribute.rs) (`eval_builtin!`)
...
- [User reference for `xmlwriter_end_attribute()`](../../../php/builtins/xml/xmlwriter_end_attribute.md)
