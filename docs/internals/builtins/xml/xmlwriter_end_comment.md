...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:999](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L999) (`xmlwriter_end_comment`)
