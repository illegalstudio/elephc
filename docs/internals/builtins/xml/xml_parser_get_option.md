...
- **Lowering**: [`src/xml_prelude/build/parser.rs`:1607](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/parser.rs#L1607) (`xml_parser_get_option`)
...
- **Declaration**: [`crates/elephc-magician/src/interpreter/builtins/xml/xml_parser_get_option.rs`](https://github.com/illegalstudio/elephc/blob/main/crates/elephc-magician/src/interpreter/builtins/xml/xml_parser_get_option.rs) (`eval_builtin!`)
...
- [User reference for `xml_parser_get_option()`](../../../php/builtins/xml/xml_parser_get_option.md)
