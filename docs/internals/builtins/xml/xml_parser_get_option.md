...
- **Lowering**: [`src/xml_prelude/build/parser.rs`:1579](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/parser.rs#L1579) (`xml_parser_get_option`)
