...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1418](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1418) (`xmlwriter_write_dtd_entity`)
