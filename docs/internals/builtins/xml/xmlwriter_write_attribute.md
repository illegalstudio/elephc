...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1033](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1033) (`xmlwriter_write_attribute`)
