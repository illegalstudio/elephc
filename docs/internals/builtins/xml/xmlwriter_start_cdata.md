...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1187](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1187) (`xmlwriter_start_cdata`)
