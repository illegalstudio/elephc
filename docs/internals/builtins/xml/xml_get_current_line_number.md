...
- **Lowering**: [`src/xml_prelude/build/parser.rs`:1542](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/parser.rs#L1542) (`xml_get_current_line_number`)
