...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1259](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1259) (`xmlwriter_end_document`)
