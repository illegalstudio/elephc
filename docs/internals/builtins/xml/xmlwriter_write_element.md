...
- **Lowering**: [`src/xml_prelude/build/writer.rs`:1142](https://github.com/illegalstudio/elephc/blob/main/src/xml_prelude/build/writer.rs#L1142) (`xmlwriter_write_element`)
