...
Eval path component dispatch includes `basename()` and `dirname()` in the interpreter, including suffix trimming and repeated parent traversal without a filesystem lookup.
