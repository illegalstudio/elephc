...
- internal `if` regions pruned when outer pure variable guards already determine a nested branch outcome, with guard invalidation on relevant local writes to stay conservative
