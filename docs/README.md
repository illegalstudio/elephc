...
- [PDO (Databases)](php/pdo.md) — versioned PDO 8.0–8.6 connections, statements, fetch modes, transactions, and driver APIs for SQLite, PostgreSQL, MySQL/MariaDB, DBLIB, Firebird, ODBC, Informix, IBM, SQLSRV, OCI, and CUBRID
