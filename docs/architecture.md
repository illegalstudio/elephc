...
│       ├── arrays/            heap_alloc, heap_free, array_free_deep, array_grow, hash_grow, hash_*, sort, usort, refcount, gc/decref dispatch, ... (84 files)
...
| GC statistics and cycle state | `_gc_allocs`, `_gc_frees`, `_gc_peak`, `_gc_collecting`, `_gc_release_suppressed` | Allocation/free counters plus targeted-cycle-collector coordination flags |
