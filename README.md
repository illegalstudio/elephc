...
- **Types**: union types (`int|string`), nullable (`?int`), `never` return type, type casting, typed properties, typed function, method, closure, and arrow parameters and returns
