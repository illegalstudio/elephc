...
- [x] Parser-free production declarations — DateTime/DatePeriod and timelib helper surfaces are checked-in direct Rust AST with test-only PHP generation oracles; final parity evidence is 319 DateTime codegen tests, 679/679 executable php-src `ext/date` PHPTs plus 13 matching skips, five-target assembly, and linked iOS device/simulator static libraries
