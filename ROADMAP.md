...
- [ ] **`phar://` advanced writes** — native PHAR writes now preserve and update
  multiple uncompressed entries through a read-modify-write bridge. Deferred:
  compressed-entry writes, tar/zip writes, OpenSSL/private-key signing, and
  concurrent PHAR write streams.
