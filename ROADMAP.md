...
- [x] PHP-compatible `defined('Class::CONST')` lookup — public class/interface constants and enum cases, case-sensitive member names, inherited and implemented-interface constants, scope-aware private/protected visibility, and lexical `self::`/`parent::`
